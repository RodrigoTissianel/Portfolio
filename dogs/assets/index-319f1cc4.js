...
function Yl(e, t, n, r, l) {
  ...
  if (((i = 0), (r = r === "" ? "." : r + ":"), Xu(e)))
    ...
    for (e = u.call(e), a = 0; !(o = e.next()).done; )
      (o = o.value), (u = r + oi(o, a++)), (i += Yl(o, t, n, u, l));
  else if (o === "object")
    throw (
      ((t = String(e)),
      Error(
...
Q.cloneElement = function (e, t, n) {
  ...
  if (t != null) {
    if (
      (t.ref !== void 0 && ((o = t.ref), (i = Ha.current)),
...
Q.isValidElement = Va;
Q.lazy = function (e) {
  return { $$typeof: Dp, _payload: { _status: -1, _result: e }, _init: Ip };
};
Q.memo = function (e, t) {
 ...
 */ var Bp = E,
  ...
  Qp = Bp.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,
 ...
 */ (function (e) {
  ...
  function r(T) {
    ...
    if (H !== U) {
      T[0] = H;
      e: for (var X = 0, b = T.length, Ze = b >>> 1; X < Ze; ) {
        var Te = 2 * (X + 1) - 1,
          vn = T[Te],
          Pt = Te + 1,
          An = T[Pt];
        if (0 > l(vn, H))
          Pt < b && 0 > l(An, vn)
            ? ((T[X] = An), (T[Pt] = H), (X = Pt))
            : ((T[X] = vn), (T[Te] = H), (X = Te));
        else if (Pt < b && 0 > l(An, H)) (T[X] = An), (T[Pt] = H), (X = Pt);
        else break e;
      }
    }
    return U;
  ...
  function l(T, U) {
    var H = T.sortIndex - U.sortIndex;
    return H !== 0 ? H : T.id - U.id;
  }
  ...
  function c(T) {
    if (((x = !1), v(T), !w))
      if (n(u) !== null) (w = !0), $t(k);
        ...
        var U = n(s);
        U !== null && _t(c, U.startTime - T);
      }
  }
  function k(T, U) {
    (w = !1), x && ((x = !1), p(N), (N = -1)), (S = !0);
    var H = m;
    try {
      for (
        v(U), g = n(u);
        g !== null && (!(g.expirationTime > U) || (T && !le()));

      ) {
        var X = g.callback;
        if (typeof X == "function") {
          (g.callback = null), (m = g.priorityLevel);
          var b = X(g.expirationTime <= U);
          (U = e.unstable_now()),
      ...
      if (g !== null) var Ze = !0;
        ...
        var Te = n(s);
        Te !== null && _t(c, Te.startTime - U), (Ze = !1);
      }
      return Ze;
    } finally {
      (g = null), (m = H), (S = !1);
  ...
  (e.unstable_IdlePriority = 5),
    ...
    (e.unstable_scheduleCallback = function (T, U, H) {
      ...
      return (
        ...
        H > X
          ? ((T.sortIndex = H),
            ...
            n(u) === null &&
              T === n(s) &&
              (x ? (p(N), (N = -1)) : (x = !0), _t(c, H - X)))
          : ((T.sortIndex = b), t(u, T), w || S || ((w = !0), $t(k))),
        T
      );
    }),
...
function ar(e, t) {
  for (el[e] = t, e = 0; e < t.length; e++) Bc.add(t[e]);
}
var Dt = !(
    typeof window > "u" ||
...
function Yi(e, t) {
  ...
  t.hasOwnProperty("value")
    ? Gi(e, t.type, n)
    : t.hasOwnProperty("defaultValue") && Gi(e, t.type, un(t.defaultValue)),
    t.checked == null &&
...
function os(e) {
  if ((e = Sl(e))) {
    ...
    var t = e.stateNode;
    t && ((t = Io(t)), ta(e.stateNode, e.type, t));
  }
}
function bc(e) {
...
function ed() {
  if (tr) {
    var e = tr,
      t = nr;
    if (((nr = tr = null), os(e), t)) for (e = 0; e < t.length; e++) os(t[e]);
  }
}
function td(e, t) {
  return e(t);
...
function oh(e, t, n, r, l, o, i, a, u) {
  (Wr = !1), (ao = null), rh.apply(lh, arguments);
}
function ih(e, t, n, r, l, o, i, a, u) {
  if ((oh.apply(this, arguments), Wr)) {
    if (Wr) {
      var s = ao;
      (Wr = !1), (ao = null);
...
var ad = We.unstable_scheduleCallback,
  as = We.unstable_cancelCallback,
  uh = We.unstable_shouldYield,
  sh = We.unstable_requestPaint,
  me = We.unstable_now,
  ch = We.unstable_getCurrentPriorityLevel,
  Ja = We.unstable_ImmediatePriority,
  ud = We.unstable_UserBlockingPriority,
  so = We.unstable_NormalPriority,
  dh = We.unstable_LowPriority,
...
function fh(e) {
  if (vt && typeof vt.onCommitFiberRoot == "function")
    try {
      vt.onCommitFiberRoot(Do, e, void 0, (e.current.flags & 128) === 128);
    } catch {}
}
var ut = Math.clz32 ? Math.clz32 : mh,
  ph = Math.log,
  hh = Math.LN2;
function mh(e) {
...
function xh(e, t, n, r, l) {
  switch (t) {
    ...
    case "pointerover":
      var o = l.pointerId;
      return rl.set(o, Rr(rl.get(o) || null, e, t, n, r, l)), !0;
    case "gotpointercapture":
      return (
        (o = l.pointerId), ll.set(o, Rr(ll.get(o) || null, e, t, n, r, l)), !0
      );
  }
  return !1;
}
...
function Lr(e, t) {
  e.blockedOn === t &&
    ...
    oa ||
      ((oa = !0),
      We.unstable_scheduleCallback(We.unstable_NormalPriority, Sh)));
}
function ol(e) {
  function t(l) {
    return Lr(l, e);
  ...
  for (; 0 < Yt.length && ((n = Yt[0]), n.blockedOn === null); )
    vd(n), n.blockedOn === null && Yt.shift();
}
...
function eu(e, t, n, r) {
  if (fo) {
    var l = ia(e, t, n, r);
    if (l === null) xi(e, t, r, po, n), us(e, r);
    else if (xh(l, e, t, n, r)) r.stopPropagation();
    else if ((us(e, r), t & 4 && -1 < wh.indexOf(e))) {
      for (; l !== null; ) {
        var o = Sl(l);
        if (
          (o !== null && fd(o),
          (o = ia(e, t, n, r)),
          o === null && xi(e, t, r, po, n),
          o === l)
        )
          break;
        l = o;
...
var po = null;
function ia(e, t, n, r) {
  if (((po = null), (e = Xa(r)), (e = En(e)), e !== null))
...
var vr = {
  ...
  Oo = ue({}, xl, {
    ...
    movementX: function (e) {
      return "movementX" in e
        ...
        : (e !== jr &&
            (jr && e.type === "mousemove"
              ? ((di = e.screenX - jr.screenX), (fi = e.screenY - jr.screenY))
              : (fi = di = 0),
            (jr = e)),
          di);
    },
  ...
  ds = Ke(Oo),
  _h = ue({}, Oo, { dataTransfer: 0 }),
  Ph = Ke(_h),
  Rh = ue({}, xl, { relatedTarget: 0 }),
  pi = Ke(Rh),
  Lh = ue({}, vr, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  jh = Ke(Lh),
  Nh = ue({}, vr, {
...
var Uh = ue({}, xl, {
  ...
  Bh = Ke($h),
  Hh = ue({}, vr, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Vh = Ke(Hh),
  Wh = ue({}, Oo, {
    deltaX: function (e) {
...
var Zh = Dt && "TextEvent" in window && !Qr,
  wd = Dt && (!lu || (Qr && 8 < Qr && 11 >= Qr)),
...
function Gh(e, t) {
  if (Vn)
    return e === "compositionend" || (!lu && xd(e, t))
      ? ((e = yd()), (Jl = tu = Xt = null), (Vn = !1), e)
      : null;
  switch (e) {
    case "paste":
      return null;
  ...
  if (Dt) {
    ...
    if (!mi) {
      ...
      gs.setAttribute("oninput", "return;"),
        (mi = typeof gs.oninput == "function");
    }
    hi = mi;
  } else hi = !1;
  Ed = hi && (!document.documentMode || 9 < document.documentMode);
}
function ys() {
  Kr && (Kr.detachEvent("onpropertychange", kd), (il = Kr = null));
}
function kd(e) {
  if (e.propertyName === "value" && Fo(il)) {
    var t = [];
    Cd(t, il, e, Xa(e)), rd(Jh, t);
  }
}
function bh(e, t, n) {
  e === "focusin"
    ? (ys(), (Kr = t), (il = n), Kr.attachEvent("onpropertychange", kd))
    : e === "focusout" && ys();
}
function e1(e) {
...
function al(e, t) {
  ...
  for (r = 0; r < n.length; r++) {
    var l = n[r];
    if (!Hi.call(t, l) || !ct(e[l], t[l])) return !1;
  }
  return !0;
}
function ws(e) {
...
var o1 = Dt && "documentMode" in document && 11 >= document.documentMode,
  Wn = null,
  aa = null,
  Zr = null,
  ua = !1;
...
function Uo(e) {
  ...
  var t = Qn[e],
    n;
  for (n in t) if (t.hasOwnProperty(n) && n in Rd) return (vi[e] = t[n]);
  return e;
}
var Ld = Uo("animationend"),
  jd = Uo("animationiteration"),
...
for (var gi = 0; gi < Cs.length; gi++) {
  var yi = Cs[gi],
    i1 = yi.toLowerCase(),
    a1 = yi[0].toUpperCase() + yi.slice(1);
  dn(i1, "on" + a1);
}
dn(Ld, "onAnimationEnd");
dn(jd, "onAnimationIteration");
dn(Nd, "onAnimationStart");
dn("dblclick", "onDoubleClick");
dn("focusin", "onFocus");
dn("focusout", "onBlur");
dn(Td, "onTransitionEnd");
...
var Hr =
  ...
  u1 = new Set("cancel close invalid load scroll toggle".split(" ").concat(Hr));
function Es(e, t, n) {
...
function zd(e, t) {
  ...
  if (uo) throw ((e = ra), (uo = !1), (ra = null), e);
}
function te(e, t) {
  var n = t[pa];
  ...
  if (!e[Il]) {
    (e[Il] = !0),
      Bc.forEach(function (n) {
        n !== "selectionchange" && (u1.has(n) || wi(n, !1, e), wi(n, !0, e));
      });
    var t = e.nodeType === 9 ? e : e.ownerDocument;
    t === null || t[Il] || ((t[Il] = !0), wi("selectionchange", !1, t));
  }
}
function Dd(e, t, n, r) {
  switch (gd(t)) {
  ...
  rd(function () {
    ...
    e: {
      ...
      if (m !== void 0) {
        ...
        for (var f = s, v; f !== null; ) {
          ...
          if (
            (v.tag === 5 &&
              c !== null &&
              ((v = c),
              p !== null && ((c = nl(f, p)), c != null && x.push(sl(f, c, v)))),
            L)
          )
            break;
          f = f.return;
        ...
        0 < x.length &&
          ((m = new S(m, w, null, n, d)), g.push({ event: m, listeners: x }));
      }
    }
    if (!(t & 7)) {
      e: {
        ...
        if (
          ...
          if (
            ...
            t: {
              for (x = S, p = w, f = 0, v = x; v; v = $n(v)) f++;
              for (v = 0, c = p; c; c = $n(c)) v++;
              for (; 0 < f - v; ) (x = $n(x)), f--;
              for (; 0 < v - f; ) (p = $n(p)), v--;
              for (; f--; ) {
      ...
      switch (((j = s ? Kn(s) : window), e)) {
        case "focusin":
          (vs(j) || j.contentEditable === "true") &&
            ((Wn = j), (aa = s), (Zr = null));
          break;
        case "focusout":
          Zr = aa = Wn = null;
      ...
      if (lu)
        ...
        Vn
          ? xd(e, n) && (N = "onCompositionEnd")
          : e === "keydown" && n.keyCode === 229 && (N = "onCompositionStart");
      N &&
        (wd &&
          n.locale !== "ko" &&
          (Vn || N !== "onCompositionStart"
            ? N === "onCompositionEnd" && Vn && (P = yd())
            : ((Xt = d),
              (tu = "value" in Xt ? Xt.value : Xt.textContent),
              (Vn = !0))),
        (j = ho(s, N)),
        0 < j.length &&
          ((N = new fs(N, e, null, n, d)),
          g.push({ event: N, listeners: j }),
          P ? (N.data = P) : ((P = Sd(n)), P !== null && (N.data = P)))),
        (P = Zh ? Yh(e, n) : Gh(e, n)) &&
          ((s = ho(s, "onBeforeInput")),
          0 < s.length &&
...
function ho(e, t) {
  for (var n = t + "Capture", r = []; e !== null; ) {
    ...
    l.tag === 5 &&
      ...
      ((l = o),
      (o = nl(e, n)),
      o != null && r.unshift(sl(e, o, l)),
      (o = nl(e, t)),
      o != null && r.push(sl(e, o, l))),
      (e = e.return);
  }
  return r;
}
...
function ks(e, t, n, r, l) {
  for (var o = t._reactName, i = []; n !== null && n !== r; ) {
    ...
    a.tag === 5 &&
      ...
      ((a = s),
      l
        ? ((u = nl(n, o)), u != null && i.unshift(sl(n, u, a)))
        : l || ((u = nl(n, o)), u != null && i.push(sl(n, u, a)))),
      (n = n.return);
  }
...
function Al(e, t, n) {
  if (((t = _s(t)), _s(e) !== t && n)) throw Error(R(425));
}
function mo() {}
var sa = null,
  ca = null;
...
var fa = typeof setTimeout == "function" ? setTimeout : void 0,
  ...
  f1 =
    typeof queueMicrotask == "function"
      ...
      : typeof Ps < "u"
      ? function (e) {
          return Ps.resolve(null).then(e).catch(p1);
        }
      : fa;
function p1(e) {
  setTimeout(function () {
...
var gr = Math.random().toString(36).slice(2),
  ...
  pa = "__reactEvents$" + gr,
  h1 = "__reactListeners$" + gr,
  m1 = "__reactHandles$" + gr;
function En(e) {
  var t = e[mt];
  if (t) return t;
...
function Ls(e, t, n) {
  if (je.current !== sn) throw Error(R(168));
  ee(je, t), ee(Ie, n);
}
function Od(e, t, n) {
  var r = e.stateNode;
...
function pn() {
  if (!Ci && jt !== null) {
    ...
    try {
      ...
      throw (jt !== null && (jt = jt.slice(e + 1)), ad(Ja, pn), l);
    } finally {
      (Y = t), (Ci = !1);
    }
  }
...
var Yn = [],
  ...
  Tt = "";
function Sn(e, t) {
  (Yn[Gn++] = wo), (Yn[Gn++] = yo), (yo = e), (wo = t);
}
function Ud(e, t, n) {
  (Ge[Xe++] = Nt), (Ge[Xe++] = Tt), (Ge[Xe++] = Nn), (Nn = e);
  var r = Nt;
  e = Tt;
  var l = 32 - ut(r) - 1;
  (r &= ~(1 << l)), (n += 1);
...
function iu(e) {
  e.return !== null && (Sn(e, 1), Ud(e, 1, 0));
}
function au(e) {
  for (; e === yo; )
    (yo = Yn[--Gn]), (Yn[Gn] = null), (wo = Yn[--Gn]), (Yn[Gn] = null);
  for (; e === Nn; )
    (Nn = Ge[--Xe]),
      (Ge[Xe] = null),
      (Tt = Ge[--Xe]),
  ...
  switch (e.tag) {
      ...
      return (
        (t =
          t.nodeType !== 1 || n.toLowerCase() !== t.nodeName.toLowerCase()
            ...
            : t),
        t !== null
          ? ((e.stateNode = t), (Ve = e), (He = tn(t.firstChild)), !0)
          : !1
      );
    case 6:
      return (
    ...
    case 13:
      return (
        ...
        t !== null
          ? ((n = Nn !== null ? { id: Nt, overflow: Tt } : null),
            (e.memoizedState = {
              dehydrated: t,
              treeContext: n,
...
function $l(e) {
  ...
  if (
    ...
    if (ma(e)) throw (Ad(), Error(R(418)));
    for (; t; ) Id(e, t), (t = tn(t.nextSibling));
  }
  if ((Ts(e), e.tag === 13)) {
  ...
  } else He = Ve ? tn(e.stateNode.nextSibling) : null;
  return !0;
}
function Ad() {
...
var g1 = It.ReactCurrentBatchConfig;
function lt(e, t) {
  if (e && e.defaultProps) {
...
function Co(e, t, n, r) {
  ...
  if (o !== null) {
        ...
        e: {
          ...
          switch (((m = t), (S = n), x.tag)) {
            ...
            case 0:
              if (
                ((w = x.payload),
                (m = typeof w == "function" ? w.call(S, g, m) : w),
                m == null)
              )
                break e;
              g = ue({}, g, m);
    ...
    (Mn |= i), (e.lanes = i), (e.memoizedState = g);
  }
}
function zs(e, t, n) {
...
function Vd(e, t, n) {
  ...
  return (
    typeof o == "object" && o !== null
      ? (o = be(o))
      : ((l = Ae(t) ? jn : je.current),
        (r = t.contextTypes),
        (o = (r = r != null) ? ur(e, l) : sn)),
    (t = new t(n, o)),
...
function wa(e, t, n, r) {
  var l = e.stateNode;
  (l.props = n), (l.state = e.memoizedState), (l.refs = Hd), pu(e);
  var o = t.contextType;
  typeof o == "object" && o !== null
    ? (l.context = be(o))
    : ((o = Ae(t) ? jn : je.current), (l.context = ur(e, o))),
...
function Wd(e) {
  ...
  function a(p, f, v, c) {
    return f === null || f.tag !== 6
      ? ((f = ji(v, p.mode, c)), (f.return = p), f)
      : ((f = l(f, v)), (f.return = p), f);
  }
  function u(p, f, v, c) {
    var k = v.type;
    return k === Hn
      ? d(p, f, v.props.children, c, v.key)
      : f !== null &&
        (f.elementType === k ||
          (typeof k == "object" &&
            k !== null &&
            k.$$typeof === Kt &&
            Fs(k) === f.type))
      ? ((c = l(f, v.props)), (c.ref = Nr(p, f, v)), (c.return = p), c)
      : ((c = oo(v.type, v.key, v.props, null, p.mode, c)),
        (c.ref = Nr(p, f, v)),
        (c.return = p),
        c);
  }
  function s(p, f, v, c) {
    return f === null ||
      ...
      ? ((f = Ni(v, p.mode, c)), (f.return = p), f)
      : ((f = l(f, v.children || [])), (f.return = p), f);
  }
  function d(p, f, v, c, k) {
    return f === null || f.tag !== 7
      ? ((f = Ln(v, p.mode, c, k)), (f.return = p), f)
      : ((f = l(f, v)), (f.return = p), f);
  }
  function g(p, f, v) {
    if ((typeof f == "string" && f !== "") || typeof f == "number")
      return (f = ji("" + f, p.mode, v)), (f.return = p), f;
    if (typeof f == "object" && f !== null) {
      switch (f.$$typeof) {
        case Nl:
          return (
            (v = oo(f.type, f.key, f.props, null, p.mode, v)),
            (v.ref = Nr(p, null, f)),
            (v.return = p),
            v
          );
        case Bn:
          return (f = Ni(f, p.mode, v)), (f.return = p), f;
        case Kt:
          var c = f._init;
          return g(p, c(f._payload), v);
      }
      if ($r(f) || _r(f))
  ...
  function m(p, f, v, c) {
    ...
    if ((typeof v == "string" && v !== "") || typeof v == "number")
      return k !== null ? null : a(p, f, "" + v, c);
    if (typeof v == "object" && v !== null) {
      switch (v.$$typeof) {
        case Nl:
          return v.key === k ? u(p, f, v, c) : null;
        case Bn:
          return v.key === k ? s(p, f, v, c) : null;
        case Kt:
          return (k = v._init), m(p, f, k(v._payload), c);
      }
      if ($r(v) || _r(v)) return k !== null ? null : d(p, f, v, c, null);
      Bl(p, v);
    }
    return null;
  }
  function S(p, f, v, c, k) {
    if ((typeof c == "string" && c !== "") || typeof c == "number")
      return (p = p.get(v) || null), a(f, p, "" + c, k);
    if (typeof c == "object" && c !== null) {
      switch (c.$$typeof) {
        case Nl:
          return (p = p.get(c.key === null ? v : c.key) || null), u(f, p, c, k);
        case Bn:
          return (p = p.get(c.key === null ? v : c.key) || null), s(f, p, c, k);
        case Kt:
          var j = c._init;
          return S(p, f, v, j(c._payload), k);
      }
      if ($r(c) || _r(c)) return (p = p.get(v) || null), d(f, p, c, k, null);
      Bl(f, c);
    }
    return null;
  }
  function w(p, f, v, c) {
    for (
      var k = null, j = null, P = f, N = (f = 0), B = null;
      P !== null && N < v.length;
      N++
    ) {
    ...
    if (N === v.length) return n(p, P), re && Sn(p, N), k;
    if (P === null) {
      for (; N < v.length; N++)
        (P = g(p, v[N], c)),
          P !== null &&
            ((f = o(P, f, N)), j === null ? (k = P) : (j.sibling = P), (j = P));
      return re && Sn(p, N), k;
    }
    for (P = r(p, P); N < v.length; N++)
      (B = S(P, p, N, v[N], c)),
        B !== null &&
          (e && B.alternate !== null && P.delete(B.key === null ? N : B.key),
          (f = o(B, f, N)),
          j === null ? (k = B) : (j.sibling = B),
          (j = B));
    return (
      e &&
  ...
  function x(p, f, v, c) {
    ...
    for (
      var j = (k = null), P = f, N = (f = 0), B = null, F = v.next();
      P !== null && !F.done;
      N++, F = v.next()
    ) {
      P.index > N ? ((B = P), (P = null)) : (B = P.sibling);
      var le = m(p, P, F.value, c);
      if (le === null) {
        P === null && (P = B);
        break;
      }
      e && P && le.alternate === null && t(p, P),
        (f = o(le, f, N)),
        j === null ? (k = le) : (j.sibling = le),
        (j = le),
        (P = B);
    }
    if (F.done) return n(p, P), re && Sn(p, N), k;
    if (P === null) {
      for (; !F.done; N++, F = v.next())
        (F = g(p, F.value, c)),
          F !== null &&
            ((f = o(F, f, N)), j === null ? (k = F) : (j.sibling = F), (j = F));
      return re && Sn(p, N), k;
    }
    for (P = r(p, P); !F.done; N++, F = v.next())
      (F = S(P, p, N, F.value, c)),
        F !== null &&
          (e && F.alternate !== null && P.delete(F.key === null ? N : F.key),
          (f = o(F, f, N)),
          j === null ? (k = F) : (j.sibling = F),
          (j = F));
    return (
      ...
      switch (v.$$typeof) {
        case Nl:
          e: {
            ...
            v.type === Hn
              ? ((f = Ln(v.props.children, p.mode, c, v.key)),
                (f.return = p),
                (p = f))
              : ((c = oo(v.type, v.key, v.props, null, p.mode, c)),
                (c.ref = Nr(p, f, v)),
        ...
        case Bn:
          e: {
            ...
            (f = Ni(v, p.mode, c)), (f.return = p), (p = f);
          }
          return i(p);
        case Kt:
          return (j = v._init), L(p, f, j(v._payload), c);
      }
      if ($r(v)) return w(p, f, v, c);
      if (_r(v)) return x(p, f, v, c);
      Bl(p, v);
    }
    return (typeof v == "string" && v !== "") || typeof v == "number"
      ? ((v = "" + v),
        f !== null && f.tag === 6
          ...
          : (n(p, f), (f = ji(v, p.mode, c)), (f.return = p), (p = f)),
        i(p))
      : n(p, f);
  }
  return L;
...
function hu(e, t) {
  switch ((ee(fl, t), ee(dl, e), ee(gt, Cl), (e = t.nodeType), e)) {
    case 9:
    case 11:
...
var eo = It.ReactCurrentDispatcher,
  ki = It.ReactCurrentBatchConfig,
  Tn = 0,
  ae = null,
  we = null,
  Se = null,
...
function yu(e, t, n, r, l, o) {
  if (
    ...
    (t.updateQueue = null),
    (t.lanes = 0),
    (eo.current = e === null || e.memoizedState === null ? C1 : E1),
    (e = n(r, l)),
    Yr)
  ) {
    o = 0;
    do {
      if (((Yr = !1), (pl = 0), 25 <= o)) throw Error(R(301));
      (o += 1),
        (Se = we = null),
        (t.updateQueue = null),
        (eo.current = k1),
...
function _i(e) {
  ...
  if (((e = n.interleaved), e !== null)) {
    l = e;
    do (o = l.lane), (ae.lanes |= o), (Mn |= o), (l = l.next);
    while (l !== e);
...
function Yd(e, t) {
  ...
  if (
    ...
    (r = r.queue),
    xu(Jd.bind(null, n, r, e), [e]),
    r.getSnapshot !== t || o || (Se !== null && Se.memoizedState.tag & 1))
  ) {
    if (
      ((n.flags |= 2048),
      ml(9, Xd.bind(null, n, r, l, t), void 0, null),
      Ce === null)
    )
      throw Error(R(349));
    Tn & 30 || Gd(n, t, l);
...
function Us(e) {
  ...
  return (
    ...
    (t.queue = e),
    (e = e.dispatch = S1.bind(null, ae, e)),
    [t.memoizedState, e]
  );
}
function ml(e, t, n, r) {
...
function Bo(e, t, n, r) {
  ...
  (ae.flags |= e), (l.memoizedState = ml(1 | t, n, o, r));
}
function Is(e, t) {
...
function lf(e, t, n) {
  return (
    (n = n != null ? n.concat([e]) : null), Bo(4, 4, rf.bind(null, t, e), n)
  );
}
function Su() {}
function of(e, t) {
...
function uf(e, t, n) {
  return Tn & 21
    ? (ct(n, t) || ((n = cd()), (ae.lanes |= n), (Mn |= n), (e.baseState = !0)),
      t)
...
function S1(e, t, n) {
  ...
  if (cf(e)) df(t, l);
    ...
    if (
      ...
      try {
        var i = t.lastRenderedState,
          a = o(i, n);
        if (((l.hasEagerState = !0), (l.eagerState = a), ct(a, i))) {
          var u = t.interleaved;
          u === null
            ? ((l.next = l), fu(t))
    ...
    (n = $d(e, t, l, r)),
      n !== null && ((l = ze()), st(n, e, r, l), ff(n, t, r));
  }
}
function cf(e) {
  var t = e.alternate;
...
var _o = {
  ...
  C1 = {
    ...
    useImperativeHandle: function (e, t, n) {
      return (
        ...
        to(4194308, 4, rf.bind(null, t, e), n)
      );
    },
    ...
    useReducer: function (e, t, n) {
      ...
      return (
        ...
        (r.queue = e),
        (e = e.dispatch = x1.bind(null, ae, e)),
        [r.memoizedState, e]
      );
    },
    useRef: function (e) {
    ...
    useTransition: function () {
      var e = Us(!1),
        t = e[0];
      return (e = w1.bind(null, e[1])), (ht().memoizedState = e), [t, e];
    },
    ...
    useSyncExternalStore: function (e, t, n) {
      ...
      return (
        (l.queue = o),
        Is(Jd.bind(null, r, o, e), [e]),
        (r.flags |= 2048),
        ml(9, Xd.bind(null, r, o, n, t), void 0, null),
        n
      );
    },
    useId: function () {
  ...
  E1 = {
    ...
    useDeferredValue: function (e) {
      var t = et();
      return uf(t, we.memoizedState, e);
    },
    useTransition: function () {
      var e = _i(hl)[0],
        t = et().memoizedState;
  ...
  k1 = {
    ...
    useDeferredValue: function (e) {
      var t = et();
      return we === null ? (t.memoizedState = e) : uf(t, we.memoizedState, e);
    },
    useTransition: function () {
      var e = Pi(hl)[0],
        t = et().memoizedState;
...
var P1 = It.ReactCurrentOwner,
  Ue = !1;
function Me(e, t, n, r) {
  t.child = e === null ? Qd(t, null, n, r) : cr(t, e.child, n, r);
}
  ...
  return (
    ...
    e !== null && !Ue
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ut(e, t, l))
      : (re && n && iu(t), (t.flags |= 1), Me(e, t, r, l), t.child)
  );
}
  ...
  return (
    ...
    e !== null && !Ue
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ut(e, t, l))
      : (re && r && iu(t), (t.flags |= 1), Me(e, t, n, l), t.child)
  );
}
function Ws(e, t, n, r, l) {
  ...
  if ((lr(t, l), t.stateNode === null))
    no(e, t), Vd(t, n, r), wa(t, n, r, l), (r = !0);
  else if (e === null) {
    var i = t.stateNode,
      a = t.memoizedProps;
    i.props = a;
    ...
    (i.state = m),
      Co(t, r, i, l),
      (u = t.memoizedState),
      a !== r || m !== u || Ie.current || Zt
        ? (typeof d == "function" && (ya(t, n, d, r), (u = t.memoizedState)),
          (a = Zt || Ds(t, n, a, r, m, u, s))
            ? (g ||
    ...
    (i = t.stateNode),
      Bd(e, t),
      (a = t.memoizedProps),
      (s = t.type === t.elementType ? a : lt(t.type, a)),
      (i.props = s),
      (g = t.pendingProps),
      (m = i.context),
      (u = n.contextType),
    ...
    a !== g || m !== w || Ie.current || Zt
      ? (typeof S == "function" && (ya(t, n, S, r), (w = t.memoizedState)),
        (s = Zt || Ds(t, n, s, r, m, w, u) || !1)
          ? (d ||
...
function Ca(e, t, n, r, l, o) {
  gf(e, t);
  var i = (t.flags & 128) !== 0;
  if (!r && !i) return l && js(t, n, !1), Ut(e, t, o);
...
function Qs(e, t, n, r, l) {
  return sr(), uu(l), (t.flags |= 256), Me(e, t, n, r), t.child;
}
...
function wf(e, t, n) {
  ...
  if (o) {
    ...
    return (
      ...
      a !== null ? (o = on(a, o)) : ((o = Ln(o, i, n, null)), (o.flags |= 2)),
      (o.return = t),
      (r.return = t),
      (r.sibling = o),
      (t.child = r),
...
function R1(e, t, n, r, l, o, i) {
  if (n)
    return t.flags & 256
      ? ((t.flags &= -257), (r = Ri(Error(R(422)))), Hl(e, t, i, r))
      : t.memoizedState !== null
  ...
  if (l.data === "$!") {
    ...
    return (r = a), (o = Error(R(419))), (r = Ri(o, r, void 0)), Hl(e, t, i, r);
  }
  if (((a = (i & e.childLanes) !== 0), Ue || a)) {
    if (((r = Ce), r !== null)) {
      ...
      (l = l & (r.suspendedLanes | i) ? 0 : l),
        l !== 0 &&
          l !== o.retryLane &&
          ((o.retryLane = l), Ft(e, l), st(r, e, l, -1));
    }
    return Lu(), (r = Ri(Error(R(421)))), Hl(e, t, i, r);
  }
  return l.data === "$?"
    ? ((t.flags |= 128),
      (t.child = e.child),
...
function xf(e, t, n) {
  var r = t.pendingProps,
    l = r.revealOrder,
    o = r.tail;
  if ((Me(e, t, r.children, n), (r = ie.current), r & 2))
    (r = (r & 1) | 2), (t.flags |= 128);
  else {
...
function L1(e, t, n) {
  switch (t.tag) {
    ...
    case 10:
      ...
      ee(xo, r._currentValue), (r._currentValue = l);
      break;
    case 13:
  ...
  switch ((au(t), t.tag)) {
        ...
        (e === null || e.child === null) &&
          ($l(t)
            ...
            : e === null ||
              ...
              ((t.flags |= 1024), at !== null && (za(at), (at = null)))),
        _a(e, t),
        Re(t),
        null
      );
    case 5:
      ...
      if (((n = t.type), e !== null && t.stateNode != null))
        ...
        if (((e = _n(gt.current)), $l(t))) {
          (r = t.stateNode), (n = t.type);
          var o = t.memoizedProps;
          switch (((r[mt] = t), (r[cl] = o), (e = (t.mode & 1) !== 0), n)) {
            case "dialog":
    ...
    case 6:
      if (e && t.stateNode != null) Ef(e, t, e.memoizedProps, r);
        ...
        if (((n = _n(fl.current)), _n(gt.current), $l(t))) {
          if (
            ((r = t.stateNode),
            (n = t.memoizedProps),
            (r[mt] = t),
    ...
    case 13:
      if (
        ...
        if (re && He !== null && t.mode & 1 && !(t.flags & 128))
          ...
          Re(t), (o = !1);
        } else at !== null && (za(at), (at = null)), (o = !0);
      ...
      return t.flags & 128
        ...
        : ((r = r !== null),
          r !== (e !== null && e.memoizedState !== null) &&
            ...
            ((t.child.flags |= 8192),
            t.mode & 1 &&
              (e === null || ie.current & 1 ? xe === 0 && (xe = 3) : Lu())),
          t.updateQueue !== null && (t.flags |= 4),
          Re(t),
          null);
    case 4:
      return (
        dr(), _a(e, t), e === null && ul(t.stateNode.containerInfo), Re(t), null
      );
    case 10:
    ...
    case 17:
      return Ae(t.type) && vo(), Re(t), null;
    case 19:
      if ((ne(ie), (o = t.memoizedState), o === null)) return Re(t), null;
                ...
                if (w !== null) {
                  var x = w.memoizedProps,
                    ...
                    f = p.getSnapshotBeforeUpdate(
                      t.elementType === t.type ? x : lt(t.type, x),
                      L
                    );
...
function Gr(e, t, n) {
  ...
  if (((r = r !== null ? r.lastEffect : null), r !== null)) {
    ...
    do {
      if ((l.tag & e) === e) {
        var o = l.destroy;
        (l.destroy = void 0), o !== void 0 && Pa(t, n, o);
      }
      l = l.next;
    } while (l !== r);
  }
...
function kf(e) {
  ...
  t !== null && ((e.alternate = null), kf(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[mt], delete t[cl], delete t[pa], delete t[h1], delete t[m1])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
        ...
        e: for (; a !== null; ) {
          switch (a.tag) {
            case 5:
              ...
              break e;
            case 3:
              (Ee = a.stateNode.containerInfo), (ot = !0);
              break e;
            case 4:
              (Ee = a.stateNode.containerInfo), (ot = !0);
              break e;
...
function Rf(e, t) {
  ...
  switch (e.tag) {
    ...
    case 15:
      ...
      break;
    case 1:
      rt(t, e), pt(e), r & 512 && n !== null && Jn(n, n.return);
      break;
    case 5:
      if (
        (rt(t, e),
      ...
      if (r & 4 && ((l = e.stateNode), l != null)) {
        ...
        if (((e.updateQueue = null), u !== null))
          try {
            a === "input" && o.type === "radio" && o.name != null && Zc(l, o),
              bi(a, i);
            var s = bi(a, o);
    ...
    case 22:
      if (
        ...
        e.mode & 1 ? ((Le = (s = Le) || d), rt(t, e), (Le = s)) : rt(t, e),
        pt(e),
        r & 8192)
      ) {
        if (
          ...
          for (z = l; z !== null; )
            (i = z),
              ...
              i.tag === 22 && i.memoizedState !== null
                ...
                ? ((u.return = i), (z = u))
                : qs(l);
        for (; o !== null; ) (z = o), Lf(o), (o = o.sibling);
        (z = l), (Vl = a), (Le = s);
      }
      Xs(e);
    } else
      l.subtreeFlags & 8772 && o !== null ? ((o.return = l), (z = o)) : Xs(e);
  }
}
function Xs(e) {
  for (; z !== null; ) {
...
var D1 = Math.ceil,
  Po = It.ReactCurrentDispatcher,
  Eu = It.ReactCurrentOwner,
...
function st(e, t, n, r) {
  if (50 < Jr) throw ((Jr = 0), (Ta = null), Error(R(185)));
  wl(e, n, r),
    (!(Z & 2) || e !== Ce) &&
      (e === Ce && (!(Z & 2) && (Vo |= n), xe === 4 && Gt(e, ke)),
      $e(e, r),
      n === 1 && Z === 0 && !(t.mode & 1) && ((pr = me() + 500), Ao && pn()));
}
function $e(e, t) {
  var n = e.callbackNode;
  gh(e, t);
  var r = co(e, e === Ce ? ke : 0);
  if (r === 0)
    n !== null && as(n), (e.callbackNode = null), (e.callbackPriority = 0);
  else if (((t = r & -r), e.callbackPriority !== t)) {
    if ((n != null && as(n), t === 1))
      e.tag === 0 ? v1(bs.bind(null, e)) : Fd(bs.bind(null, e)),
        f1(function () {
          !(Z & 6) && pn();
        }),
        (n = null);
      ...
      n = Ff(n, jf.bind(null, e));
    }
    (e.callbackPriority = t), (e.callbackNode = n);
  }
}
function jf(e, t) {
  if (((ro = -1), (lo = 0), Z & 6)) throw Error(R(327));
  var n = e.callbackNode;
  ...
  if (r & 30 || r & e.expiredLanes || t) t = jo(e, r);
    ...
    Z |= 2;
    var o = Tf();
    (Ce !== e || ke !== t) && ((Lt = null), (pr = me() + 500), Rn(e, t));
    do
      try {
        U1();
        break;
    ...
    cu(),
      (Po.current = o),
      (Z = l),
      ge !== null ? (t = 0) : ((Ce = null), (ke = 0), (t = xe));
  }
  if (t !== 0) {
    if (
      (t === 2 && ((l = la(e)), l !== 0 && ((r = l), (t = Ma(e, l)))), t === 1)
    )
      throw ((n = vl), Rn(e, 0), Gt(e, r), $e(e, me()), n);
    if (t === 6) Gt(e, r);
    else {
      if (
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if (
            ...
            e.timeoutHandle = fa(Cn.bind(null, e, Fe, Lt), t);
            break;
          }
          Cn(e, Fe, Lt);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = fa(Cn.bind(null, e, Fe, Lt), r);
            break;
          }
          Cn(e, Fe, Lt);
          break;
  ...
  return $e(e, me()), e.callbackNode === n ? jf.bind(null, e) : null;
}
function Ma(e, t) {
  var n = Xr;
  return (
...
function bs(e) {
  ...
  if (n === 1) throw ((n = vl), Rn(e, 0), Gt(e, t), $e(e, me()), n);
...
function zn(e) {
  ...
  try {
    ...
    (Y = r), (qe.transition = n), (Z = t), !(Z & 6) && pn();
  }
}
function Ru() {
  (Be = qn.current), ne(qn);
...
function Rn(e, t) {
  ...
  if ((n !== -1 && ((e.timeoutHandle = -1), d1(n)), ge !== null))
...
function Tf() {
  var e = Po.current;
  return (Po.current = _o), e === null ? _o : e;
}
function Lu() {
  (xe === 0 || xe === 3 || xe === 2) && (xe = 4),
    Ce === null || (!(Mn & 268435455) && !(Vo & 268435455)) || Gt(Ce, ke);
}
function jo(e, t) {
  var n = Z;
  Z |= 2;
  var r = Tf();
  (Ce !== e || ke !== t) && ((Lt = null), Rn(e, t));
  do
    try {
      F1();
      break;
  ...
  while (1);
  if ((cu(), (Z = n), (Po.current = r), ge !== null)) throw Error(R(261));
...
function U1() {
  for (; ge !== null && !uh(); ) Mf(ge);
}
function Mf(e) {
  var t = Of(e.alternate, e, Be);
...
function Cn(e, t, n) {
  var r = Y,
    l = qe.transition;
  try {
    (qe.transition = null), (Y = 1), I1(e, t, n, r);
  } finally {
    (qe.transition = l), (Y = r);
  }
  return null;
...
function I1(e, t, n, r) {
  ...
  if (Ro) throw ((Ro = !1), (e = Na), (Na = null), e);
  return (
    Lo & 1 && e.tag !== 0 && or(),
    (o = e.pendingLanes),
    o & 1 ? (e === Ta ? Jr++ : ((Jr = 0), (Ta = e))) : (Jr = 0),
    pn(),
    null
  );
}
function or() {
  if (Jt !== null) {
    var e = dd(Lo),
      ...
      n = Y;
    try {
      if (((qe.transition = null), (Y = 16 > e ? 16 : e), Jt === null))
        var r = !1;
      else {
        if (((e = Jt), (Jt = null), (Lo = 0), Z & 6)) throw Error(R(331));
        var l = Z;
        ...
        if (
          ((Z = l), pn(), vt && typeof vt.onPostCommitFiberRoot == "function")
        )
          try {
            vt.onPostCommitFiberRoot(Do, e);
          } catch {}
        r = !0;
      }
      return r;
...
function A1(e, t, n) {
  ...
  r !== null && r.delete(t),
    ...
    Ce === e &&
      (ke & n) === n &&
      (xe === 4 || (xe === 3 && (ke & 130023424) === ke && 500 > me() - _u)
        ? Rn(e, 0)
        : (ku |= n)),
    $e(e, t);
}
function Df(e, t) {
  t === 0 &&
    (e.mode & 1
      ...
      : (t = 1));
  var n = ze();
  (e = Ft(e, t)), e !== null && (wl(e, t, n), $e(e, n));
}
function $1(e) {
  var t = e.memoizedState,
    n = 0;
...
Of = function (e, t, n) {
  if (e !== null)
    if (e.memoizedProps !== t.pendingProps || Ie.current) Ue = !0;
      ...
      if (!(e.lanes & n) && !(t.flags & 128)) return (Ue = !1), L1(e, t, n);
      Ue = !!(e.flags & 131072);
    }
  else (Ue = !1), re && t.flags & 1048576 && Ud(t, wo, t.index);
  switch (((t.lanes = 0), t.tag)) {
    case 2:
      var r = t.type;
      no(e, t), (e = t.pendingProps);
      var l = ur(t, je.current);
      lr(t, n), (l = yu(null, t, r, e, l, n));
      var o = wu();
      return (
        (t.flags |= 1),
        typeof l == "object" &&
        ...
        l.$$typeof === void 0
          ? ((t.tag = 1),
            ...
            wa(t, r, e, n),
            (t = Ca(null, t, r, !0, o, n)))
          : ((t.tag = 0), re && o && iu(t), Me(null, t, l, n), (t = t.child)),
        t
      );
    case 16:
      r = t.elementType;
    ...
    case 3:
      e: {
        if ((yf(t), e === null)) throw Error(R(387));
        (r = t.pendingProps),
          (o = t.memoizedState),
          (l = o.element),
          Bd(e, t),
        ...
        if (((r = i.element), o.isDehydrated))
          if (
            ...
            (l = fr(Error(R(423)), t)), (t = Qs(e, t, r, n, l));
            break e;
          } else if (r !== l) {
            (l = fr(Error(R(424)), t)), (t = Qs(e, t, r, n, l));
            break e;
          } else
            for (
    ...
    case 5:
      return (
        ...
        (i = l.children),
        da(r, l) ? (i = null) : o !== null && da(r, o) && (t.flags |= 32),
        gf(e, t),
        Me(e, t, i, n),
        t.child
      );
    ...
    case 4:
      return (
        hu(t, t.stateNode.containerInfo),
        (r = t.pendingProps),
        e === null ? (t.child = cr(t, null, r, n)) : Me(e, t, r, n),
        t.child
      );
    case 11:
      return (
...
function oo(e, t, n, r, l, o) {
  ...
  if (((r = e), typeof e == "function")) ju(e) && (i = 1);
    ...
    e: switch (e) {
      ...
      case Vi:
        return (
          (e = Je(12, n, t, l | 2)), (e.elementType = Vi), (e.lanes = o), e
        );
      case Wi:
        return (e = Je(13, n, t, l)), (e.elementType = Wi), (e.lanes = o), e;
      case Qi:
        return (e = Je(19, n, t, l)), (e.elementType = Qi), (e.lanes = o), e;
      case Wc:
        return Wo(n, l, o, t);
      default:
...
function If(e, t, n, r, l, o, i, a, u) {
  return (
    (e = Nu(n, r, !0, e, l, o, i, a, u)),
    (e.context = Uf(null)),
    (n = e.current),
    (r = ze()),
    (l = ln(n)),
...
Ko.prototype.render = Mu.prototype.render = function (e) {
  var t = this._internalRoot;
  if (t === null) throw Error(R(409));
  Qo(e, t, null, null);
};
Ko.prototype.unmount = Mu.prototype.unmount = function () {
...
function Z1(e, t, n, r, l) {
  ...
  var u = Nu(e, 0, !1, null, null, !1, !1, "", nc);
  return (
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (qa(t, n | 1), $e(t, me()), !(Z & 6) && ((pr = me() + 500), pn()));
      }
      break;
    case 13:
      zn(function () {
...
td = Pu;
nd = zn;
var Y1 = { usingClientEntryPoint: !1, Events: [Sl, Kn, Io, bc, ed, Pu] },
  Mr = {
  ...
  G1 = {
    ...
    findFiberByHostInstance: Mr.findFiberByHostInstance || K1,
...
if (typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u") {
  ...
  if (!Ql.isDisabled && Ql.supportsFiber)
    try {
      (Do = Ql.inject(G1)), (vt = Ql);
    } catch {}
}
Qe.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Y1;
...
var X1 = Uc.exports,
  rc = X1;
(Bi.createRoot = rc.createRoot), (Bi.hydrateRoot = rc.hydrateRoot);
/**
...
function b1(e, t, n, r) {
  ...
  let x = {
    ...
    listen(L) {
      ...
      return (
        l.addEventListener(lc, g),
        (u = L),
        () => {
          l.removeEventListener(lc, g), (u = null);
        }
      );
    },
    createHref(L) {
...
function bn(e, t, n) {
  ...
  rm(o);
  let i = null;
  for (let a = 0; i == null && a < o.length; ++a) i = fm(o[a], hm(l));
  return i;
}
function nm(e, t) {
...
function Bf(e, t, n, r) {
  ...
  let l = (o, i, a) => {
    ...
    o.children &&
      ...
      Bf(o.children, t, d, s)),
      !(o.path == null && !o.index) &&
        t.push({ path: s, score: cm(s, o.index), routesMeta: d });
  };
  return (
    e.forEach((o, i) => {
      var a;
      if (o.path === "" || !((a = o.path) != null && a.includes("?"))) l(o, i);
      else for (let u of Hf(o.path)) l(o, i, u);
    }),
    t
  );
}
...
function cm(e, t) {
  ...
  return (
    ...
    n
      .filter((l) => !ic(l))
      .reduce((l, o) => l + (lm.test(o) ? om : o === "" ? am : um), r)
  );
}
function dm(e, t) {
...
function fm(e, t) {
  ...
  for (let i = 0; i < n.length; ++i) {
    ...
    o.push({
      ...
      pathnameBase: ym(zt([l, d.pathnameBase])),
      route: g,
    }),
...
function Oa(e, t) {
  ...
  return {
    params: r.reduce((s, d, g) => {
      ...
      const w = a[g];
      return S && !w ? (s[m] = void 0) : (s[m] = mm(w || "", m)), s;
    }, {}),
    pathname: o,
    pathnameBase: i,
    pattern: e,
  ...
  typeof e == "string"
    ...
    : ((l = de({}, e)),
      W(
        ...
        Ti("?", "pathname", "search", l)
      ),
      W(
        !l.pathname || !l.pathname.includes("#"),
        Ti("#", "pathname", "hash", l)
      ),
      W(!l.search || !l.search.includes("#"), Ti("#", "search", "hash", l)));
  let o = e === "" || l.pathname === "",
    i = o ? "/" : l.pathname,
    a;
  if (r || i == null) a = n;
...
const Wf = ["post", "put", "patch", "delete"],
  ...
  Qf = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,
  Rm = (e) => ({ hasErrorBoundary: !!e.hasErrorBoundary }),
  Kf = "remix-router-transitions";
function Lm(e) {
  ...
  let o = {},
    ...
    L = bn(i, e.history.location, u),
    p = null;
  if (L == null) {
    let y = Ye(404, { pathname: e.history.location.pathname }),
      { matches: C, route: _ } = hc(i);
    (L = C), (p = { [_.id]: y });
  }
  let f =
      !L.some((y) => y.route.lazy) &&
      (!L.some((y) => y.route.loader) || e.hydrationData != null),
    v,
    c = {
  ...
  function Pt() {
    if (
      ((d = e.history.listen((y) => {
        let { action: C, location: _, delta: M } = y;
        if (vn) {
          vn = !1;
          return;
        }
    ...
    return c.initialized || gn(pe.Pop, c.location), v;
  }
  function An() {
    d && d(),
      F && F(),
      g.clear(),
      P && P.abort(),
      c.fetchers.forEach((y, C) => Pl(C)),
      c.blockers.forEach((y, C) => Wu(C));
  }
  function dp(y) {
    return g.add(y), () => g.delete(y);
  }
  function ve(y, C) {
    c = de({}, c, y);
    let _ = [],
    ...
    s.v7_fetcherPersist &&
      c.fetchers.forEach((O, I) => {
        O.state === "idle" && (b.has(I) ? M.push(I) : _.push(I));
      }),
      g.forEach((O) =>
        O(c, { deletedFetchers: M, unstable_viewTransitionOpts: C })
      ),
      s.v7_fetcherPersist &&
        (_.forEach((O) => c.fetchers.delete(O)), M.forEach((O) => Pl(O)));
  }
  function xr(y, C) {
    var _, M;
    let O =
    ...
    C.actionData
      ...
      : (I = null);
    let V = C.loaderData
        ? pc(c.loaderData, C.loaderData, C.matches || [], C.errors)
        : c.loaderData,
      A = c.blockers;
    A.size > 0 && ((A = new Map(A)), A.forEach((oe, K) => A.set(K, zr)));
    let D =
      j === !0 ||
      (c.navigation.formMethod != null &&
        it(c.navigation.formMethod) &&
    ...
    a && ((i = a), (a = void 0)),
      le ||
        ...
        (k === pe.Push
          ...
          : k === pe.Replace && e.history.replace(y, y.state));
    let J;
    if (k === pe.Pop) {
      let oe = B.get(c.location.pathname);
      oe && oe.has(y.pathname)
      ...
      oe
        ? oe.add(y.pathname)
        : ((oe = new Set([y.pathname])), B.set(c.location.pathname, oe)),
        (J = { currentLocation: c.location, nextLocation: y });
    }
    ve(
      de({}, C, {
        ...
        navigation: Mi,
        revalidation: "idle",
        restoreScrollPosition: Zu(y, C.matches || c.matches),
  ...
  async function Iu(y, C) {
    ...
    let _ = Fa(
      ...
      ),
      {
        ...
        submission: O,
        error: I,
      } = ac(s.v7_normalizeFormMethod, !1, _, C),
      V = c.location,
      A = gl(c.location, M, C && C.state);
    A = de({}, A, e.history.encodeLocation(A));
    ...
    let oe =
      ...
      K = Qu({ currentLocation: V, nextLocation: A, historyAction: J });
    if (K) {
      Rl(K, {
        state: "blocked",
        location: A,
  ...
  function fp() {
    if (
      ...
      if (c.navigation.state === "idle") {
        gn(c.historyAction, c.location, { startUninterruptedRevalidation: !0 });
        return;
      }
      gn(k || c.historyAction, c.navigation.location, {
        overrideNavigation: c.navigation,
      });
    }
  }
  async function gn(y, C, _) {
    P && P.abort(),
      (P = null),
      (k = y),
      (le = (_ && _.startUninterruptedRevalidation) === !0),
      Sp(c.location, c.matches),
      (j = (_ && _.preventScrollReset) === !0),
      (N = (_ && _.enableViewTransition) === !0);
    let M = a || i,
      O = _ && _.overrideNavigation,
      I = bn(M, C, u);
    if (!I) {
      let q = Ye(404, { pathname: C.pathname }),
        { matches: ye, route: yn } = hc(M);
      ei(), xr(C, { matches: ye, loaderData: {}, errors: { [yn.id]: q } });
      return;
    }
    if (
      c.initialized &&
      !Ne &&
      zm(c.location, C) &&
      !(_ && _.submission && it(_.submission.formMethod))
    ) {
      xr(C, { matches: I });
      return;
    }
    P = new AbortController();
    let V = Or(e.history, C, P.signal, _ && _.submission),
      A,
      D;
    if (_ && _.pendingError) D = { [qr(I).route.id]: _.pendingError };
    else if (_ && _.submission && it(_.submission.formMethod)) {
      let q = await pp(V, C, _.submission, I, { replace: _.replace });
      if (q.shortCircuited) return;
      (A = q.pendingActionData),
        (D = q.pendingActionError),
        (O = zi(C, _.submission)),
    ...
    J ||
      ...
      xr(
        C,
        de({ matches: I }, A ? { actionData: A } : {}, {
          loaderData: oe,
          errors: K,
        })
      ));
  }
  async function pp(y, C, _, M, O) {
    O === void 0 && (O = {}), bo();
    let I = Um(C, _);
    ve({ navigation: I });
    let V,
    ...
    else if (((V = await Dr("action", y, A, M, o, l, u)), y.signal.aborted))
    ...
    if (ir(V)) {
      ...
      return (
        O && O.replace != null
          ? (D = O.replace)
          : (D = V.location === c.location.pathname + c.location.search),
        await Sr(c, V, { submission: _, replace: D }),
        { shortCircuited: !0 }
      );
    }
    if (br(V)) {
      let D = qr(M, A.route.id);
      return (
        (O && O.replace) !== !0 && (k = pe.Push),
        { pendingActionData: {}, pendingActionError: { [D.route.id]: V.error } }
      );
    }
    if (Pn(V)) throw Ye(400, { type: "defer-action" });
    return { pendingActionData: { [A.route.id]: V.data } };
  }
  async function hp(y, C, _, M, O, I, V, A, D) {
    let J = M || zi(C, O),
      oe = O || I || gc(J),
      K = a || i,
      [q, ye] = uc(e.history, c, _, oe, C, Ne, ft, mn, H, U, K, u, A, D);
    if (
      (ei(
        (G) =>
          !(_ && _.some((nt) => nt.route.id === G)) ||
          (q && q.some((nt) => nt.route.id === G))
      ),
      (_t = ++$t),
      ...
      return (
        xr(
          C,
          de(
            { matches: _, loaderData: {}, errors: D || null },
            A ? { actionData: A } : {},
    ...
    if (!le) {
      ye.forEach((nt) => {
        let Vt = c.fetchers.get(nt.key),
          fe = Fr(void 0, Vt ? Vt.data : void 0);
        c.fetchers.set(nt.key, fe);
      });
    ...
    ye.forEach((G) => {
      se.has(G.key) && Bt(G.key), G.controller && se.set(G.key, G.controller);
    });
    let yn = () => ye.forEach((G) => Bt(G.key));
    P && P.signal.addEventListener("abort", yn);
    let {
      results: wn,
      loaderResults: Er,
      fetcherResults: ti,
    } = await $u(c.matches, _, q, ye, y);
    if (y.signal.aborted) return { shortCircuited: !0 };
    P && P.signal.removeEventListener("abort", yn),
      ye.forEach((G) => se.delete(G.key));
    let Rt = mc(wn);
    if (Rt) {
      if (Rt.idx >= q.length) {
        let G = ye[Rt.idx - q.length].key;
        U.add(G);
      }
      return await Sr(c, Rt.result, { replace: V }), { shortCircuited: !0 };
    }
    let { loaderData: Ht, errors: Ll } = fc(c, _, q, Er, D, ye, ti, Ze);
    Ze.forEach((G, nt) => {
      G.subscribe((Vt) => {
        (Vt || G.done) && Ze.delete(nt);
      });
    });
    let ni = Hu(),
      ri = Vu(_t),
      li = ni || ri || ye.length > 0;
    return de(
      { loaderData: Ht, errors: Ll },
      li ? { fetchers: new Map(c.fetchers) } : {}
    );
  }
  function Au(y) {
    return (
      s.v7_fetcherPersist &&
        (X.set(y, (X.get(y) || 0) + 1), b.has(y) && b.delete(y)),
      c.fetchers.get(y) || Pm
    );
  }
  function mp(y, C, _, M) {
    ...
    let {
      ...
      submission: D,
      error: J,
    } = ac(s.v7_normalizeFormMethod, !0, I, M);
    if (J) {
      Cr(y, C, J);
      return;
    }
    let oe = Ia(V, A);
    if (((j = (M && M.preventScrollReset) === !0), D && it(D.formMethod))) {
      vp(y, C, A, oe, V, D);
      return;
    }
    H.set(y, { routeId: C, path: A }), gp(y, C, A, oe, V, D);
  }
  async function vp(y, C, _, M, O, I) {
    if ((bo(), H.delete(y), !M.route.action && !M.route.lazy)) {
      let fe = Ye(405, { method: I.formMethod, pathname: _, routeId: C });
      Cr(y, C, fe);
      return;
    }
    let V = c.fetchers.get(y),
      A = Im(I, V);
    c.fetchers.set(y, A), ve({ fetchers: new Map(c.fetchers) });
    let D = new AbortController(),
      J = Or(e.history, _, D.signal, I);
    se.set(y, D);
    let oe = $t,
      K = await Dr("action", J, M, O, o, l, u);
    if (J.signal.aborted) {
      se.get(y) === D && se.delete(y);
      return;
    }
    if (b.has(y)) {
      c.fetchers.set(y, Qt(void 0)), ve({ fetchers: new Map(c.fetchers) });
      return;
    }
    if (ir(K))
      if ((se.delete(y), _t > oe)) {
        let fe = Qt(void 0);
        c.fetchers.set(y, fe), ve({ fetchers: new Map(c.fetchers) });
        return;
      } else {
        U.add(y);
        let fe = Fr(I);
    ...
    if (Pn(K)) throw Ye(400, { type: "defer-action" });
    let q = c.navigation.location || c.location,
      ye = Or(e.history, q, D.signal),
      yn = a || i,
      wn =
        c.navigation.state !== "idle"
          ? bn(yn, c.navigation.location, u)
          : c.matches;
    ...
    Ht.filter((fe) => fe.key !== y).forEach((fe) => {
      let kr = fe.key,
        Yu = c.fetchers.get(kr),
        Ep = Fr(void 0, Yu ? Yu.data : void 0);
      c.fetchers.set(kr, Ep),
        se.has(kr) && Bt(kr),
        fe.controller && se.set(kr, fe.controller);
    }),
      ve({ fetchers: new Map(c.fetchers) });
    let Ll = () => Ht.forEach((fe) => Bt(fe.key));
    D.signal.addEventListener("abort", Ll);
    let {
      results: ni,
      loaderResults: ri,
      fetcherResults: li,
    } = await $u(c.matches, wn, Rt, Ht, ye);
    if (D.signal.aborted) return;
    D.signal.removeEventListener("abort", Ll),
      T.delete(y),
      se.delete(y),
      Ht.forEach((fe) => se.delete(fe.key));
    let G = mc(ni);
    if (G) {
      if (G.idx >= Rt.length) {
        let fe = Ht[G.idx - Rt.length].key;
        U.add(fe);
      }
      return Sr(c, G.result);
    }
    let { loaderData: nt, errors: Vt } = fc(
      c,
      c.matches,
      Rt,
      ri,
    ...
    Vu(Er),
      c.navigation.state === "loading" && Er > _t
        ? (W(k, "Expected pending action"),
          P && P.abort(),
          xr(c.navigation.location, {
            matches: wn,
            loaderData: nt,
            errors: Vt,
        ...
        : (ve({
            errors: Vt,
            loaderData: pc(c.loaderData, nt, wn, Vt),
            fetchers: new Map(c.fetchers),
          }),
          (Ne = !1));
  }
  async function gp(y, C, _, M, O, I) {
    let V = c.fetchers.get(y),
      A = Fr(I, V ? V.data : void 0);
    c.fetchers.set(y, A), ve({ fetchers: new Map(c.fetchers) });
    let D = new AbortController(),
      J = Or(e.history, _, D.signal);
    se.set(y, D);
    let oe = $t,
      K = await Dr("loader", J, M, O, o, l, u);
    if (
      (Pn(K) && (K = (await Gf(K, J.signal, !0)) || K),
      se.get(y) === D && se.delete(y),
      J.signal.aborted)
    )
      return;
    ...
    if (ir(K))
      if (_t > oe) {
        let ye = Qt(void 0);
        c.fetchers.set(y, ye), ve({ fetchers: new Map(c.fetchers) });
        return;
      } else {
        U.add(y), await Sr(c, K);
        return;
      }
    if (br(K)) {
      Cr(y, C, K.error);
    ...
    let q = Qt(K.data);
    c.fetchers.set(y, q), ve({ fetchers: new Map(c.fetchers) });
  }
  async function Sr(y, C, _) {
    let {
      submission: M,
      fetcherSubmission: O,
      replace: I,
    ...
    C.revalidate && (Ne = !0);
    let V = gl(y.location, C.location, { _isRedirect: !0 });
    if ((W(V, "Expected a location on the redirect navigation"), n)) {
      let q = !1;
      if (C.reloadDocument) q = !0;
      else if (Qf.test(C.location)) {
        const ye = e.history.createURL(C.location);
        q = ye.origin !== t.location.origin || cn(ye.pathname, u) == null;
      }
      if (q) {
        I ? t.location.replace(C.location) : t.location.assign(C.location);
        return;
      }
    }
    P = null;
    let A = I === !0 ? pe.Replace : pe.Push,
      { formMethod: D, formAction: J, formEncType: oe } = y.navigation;
    !M && !O && D && J && oe && (M = gc(y.navigation));
    let K = M || O;
    if (_m.has(C.status) && K && it(K.formMethod))
      await gn(A, V, {
        submission: de({}, K, { formAction: C.location }),
  ...
  async function $u(y, C, _, M, O) {
    let I = await Promise.all([
        ..._.map((D) => Dr("loader", O, D, C, o, l, u)),
        ...M.map((D) =>
          D.matches && D.match && D.controller
            ...
            : { type: he.error, error: Ye(404, { pathname: D.path }) }
        ),
      ]),
      V = I.slice(0, _.length),
      A = I.slice(_.length);
    return (
      await Promise.all([
        vc(
  ...
  function bo() {
    (Ne = !0),
      ft.push(...ei()),
      H.forEach((y, C) => {
        se.has(C) && (mn.push(C), Bt(C));
      });
  }
  function Cr(y, C, _) {
    let M = qr(c.matches, C);
    Pl(y), ve({ errors: { [M.route.id]: _ }, fetchers: new Map(c.fetchers) });
  }
  function Pl(y) {
    let C = c.fetchers.get(y);
    se.has(y) && !(C && C.state === "loading" && T.has(y)) && Bt(y),
      H.delete(y),
      T.delete(y),
      U.delete(y),
      b.delete(y),
  ...
  function yp(y) {
    if (s.v7_fetcherPersist) {
      let C = (X.get(y) || 0) - 1;
      C <= 0 ? (X.delete(y), b.add(y)) : X.set(y, C);
    } else Pl(y);
    ve({ fetchers: new Map(c.fetchers) });
  }
  function Bt(y) {
    let C = se.get(y);
    W(C, "Expected fetch controller: " + y), C.abort(), se.delete(y);
  }
  function Bu(y) {
    for (let C of y) {
      let _ = Au(C),
  ...
  function Hu() {
    let y = [],
      C = !1;
    for (let _ of U) {
      let M = c.fetchers.get(_);
      W(M, "Expected fetcher: " + _),
        M.state === "loading" && (U.delete(_), y.push(_), (C = !0));
    }
    return Bu(y), C;
  }
  function Vu(y) {
    ...
    for (let [_, M] of T)
      if (M < y) {
        let O = c.fetchers.get(_);
        W(O, "Expected fetcher: " + _),
          O.state === "loading" && (Bt(_), T.delete(_), C.push(_));
      }
    return Bu(C), C.length > 0;
  }
  function wp(y, C) {
    let _ = c.blockers.get(y) || zr;
    return Te.get(y) !== C && Te.set(y, C), _;
  }
  function Wu(y) {
    c.blockers.delete(y), Te.delete(y);
  }
  function Rl(y, C) {
    let _ = c.blockers.get(y) || zr;
    W(
      (_.state === "unblocked" && C.state === "blocked") ||
        (_.state === "blocked" && C.state === "blocked") ||
        (_.state === "blocked" && C.state === "proceeding") ||
        (_.state === "blocked" && C.state === "unblocked") ||
        (_.state === "proceeding" && C.state === "unblocked"),
      "Invalid blocker state transition: " + _.state + " -> " + C.state
    );
    let M = new Map(c.blockers);
    M.set(y, C), ve({ blockers: M });
  }
  function Qu(y) {
    let { currentLocation: C, nextLocation: _, historyAction: M } = y;
    if (Te.size === 0) return;
    Te.size > 1 && Dn(!1, "A router only supports one blocker at a time");
    let O = Array.from(Te.entries()),
      [I, V] = O[O.length - 1],
      A = c.blockers.get(I);
    if (
      !(A && A.state === "proceeding") &&
      V({ currentLocation: C, nextLocation: _, historyAction: M })
    )
      return I;
  }
  function ei(y) {
    ...
    return (
      Ze.forEach((_, M) => {
        (!y || y(M)) && (_.cancel(), C.push(M), Ze.delete(M));
      }),
      C
    );
  }
  function xp(y, C, _) {
    if (((m = y), (w = C), (S = _ || null), !x && c.navigation === Mi)) {
      x = !0;
      let M = Zu(c.location, c.matches);
      M != null && ve({ restoreScrollPosition: M });
    }
    return () => {
...
function Fa(e, t, n, r, l, o, i) {
  ...
  let s = Go(
    l || ".",
    El(a).map((d) => d.pathnameBase),
    cn(e.pathname, n) || e.pathname,
    i === "path"
  );
  return (
    ...
    r &&
      n !== "/" &&
      (s.pathname = s.pathname === "/" ? n : zt([n, s.pathname])),
    On(s)
  );
}
function ac(e, t, n, r) {
  if (!r || !jm(r)) return { path: n };
  if (r.formMethod && !Fm(r.formMethod))
...
`
  ...
  else if (r.body instanceof URLSearchParams) (u = r.body), (s = dc(u));
  else if (r.body == null) (u = new URLSearchParams()), (s = new FormData());
  else
    try {
      (u = new URLSearchParams(r.body)), (s = dc(u));
    } catch {
      return l();
    }
  let d = {
  ...
  let g = At(n);
  return (
    t && g.search && Ou(g.search) && u.append("index", ""),
    (g.search = "?" + u),
    { path: On(g), submission: d }
  );
}
function Nm(e, t) {
  let n = e;
...
function uc(e, t, n, r, l, o, i, a, u, s, d, g, m, S) {
  let w = S ? Object.values(S)[0] : m ? Object.values(m)[0] : void 0,
    ...
    v = Nm(n, p).filter((k, j) => {
      ...
      if (Tm(t.loaderData, t.matches[j], k) || i.some((B) => B === k.route.id))
        return !0;
      let P = t.matches[j],
        N = k;
      return sc(
        ...
        de(
          ...
          r,
          {
            ...
            defaultShouldRevalidate:
              o ||
              x.pathname + x.search === L.pathname + L.search ||
              x.search !== L.search ||
              Zf(P, N),
          }
        )
  ...
  return (
    u.forEach((k, j) => {
      if (!n.some((le) => le.route.id === k.routeId)) return;
      let P = bn(d, k.path, g);
      if (!P) {
        c.push({
          key: j,
...
async function Dr(e, t, n, r, l, o, i, a) {
  a === void 0 && (a = {});
  let u,
    s,
    d,
  ...
  try {
    ...
    if (n.route.lazy)
      if (w) {
        ...
        if (x) throw x;
        s = L[0];
      } else if ((await cc(n.route, o, l), (w = n.route[e]), w)) s = await g(w);
      else if (e === "action") {
        let x = new URL(t.url),
          L = x.pathname + x.search;
        throw Ye(405, { method: t.method, pathname: L, routeId: n.route.id });
      } else return { type: he.data, data: void 0 };
    else if (w) s = await g(w);
    else {
      let x = new URL(t.url),
        L = x.pathname + x.search;
      throw Ye(404, { pathname: L });
    }
    W(
      s !== void 0,
      "You defined " +
  ...
  if (Om(s)) {
    ...
    if (km.has(w)) {
      ...
      if (
        ...
        p = Fa(new URL(t.url), r.slice(0, r.indexOf(n) + 1), i, !0, p);
      else if (!a.isStaticRequest) {
        let f = new URL(t.url),
          v = p.startsWith("//") ? new URL(f.protocol + p) : new URL(p),
          c = cn(v.pathname, i) != null;
        v.origin === f.origin && c && (p = v.pathname + v.search + v.hash);
      }
    ...
    if (a.isRouteRequest)
      throw { type: u === he.error ? he.error : he.data, response: s };
    let x,
    ...
    return (
      L && /\bapplication\/json\b/.test(L)
        ...
        : (x = await s.text()),
      u === he.error
        ? { type: u, error: new Du(w, s.statusText, x), headers: s.headers }
        : { type: he.data, data: x, statusCode: s.status, headers: s.headers }
    );
  }
  if (u === he.error) return { type: u, error: s };
  if (Dm(s)) {
    var m, S;
    return {
      type: he.deferred,
...
function Mm(e, t, n, r, l) {
  ...
  return (
    n.forEach((d, g) => {
      let m = t[g].route.id;
      if (
        (W(!ir(d), "Cannot handle redirect results in processLoaderData"),
        br(d))
      ) {
        let S = qr(e, m),
          w = d.error;
        r && ((w = Object.values(r)[0]), (r = void 0)),
          ...
          (o[m] = void 0),
          u || ((u = !0), (a = Vf(d.error) ? d.error.status : 500)),
          d.headers && (s[m] = d.headers);
      } else
        Pn(d)
          ? (l.set(m, d.deferredData), (o[m] = d.deferredData.data))
          : (o[m] = d.data),
          d.statusCode != null &&
            d.statusCode !== 200 &&
            !u &&
...
function fc(e, t, n, r, l, o, i, a) {
  let { loaderData: u, errors: s } = Mm(t, n, r, l, a);
  for (let d = 0; d < o.length; d++) {
    let { key: g, match: m, controller: S } = o[d];
    W(
      i !== void 0 && i[d] !== void 0,
    ...
    if (!(S && S.signal.aborted))
      if (br(w)) {
        let x = qr(e.matches, m == null ? void 0 : m.route.id);
        (s && s[x.route.id]) || (s = de({}, s, { [x.route.id]: w.error })),
          e.fetchers.delete(g);
      } else if (ir(w)) W(!1, "Unhandled fetcher revalidation redirect");
      else if (Pn(w)) W(!1, "Unhandled fetcher deferred data");
      else {
        let x = Qt(w.data);
        e.fetchers.set(g, x);
      }
...
function Fm(e) {
  return Em.has(e.toLowerCase());
}
function it(e) {
  return Sm.has(e.toLowerCase());
}
async function vc(e, t, n, r, l, o) {
  for (let i = 0; i < n.length; i++) {
    let a = n[i],
      u = t[i];
    if (!u) continue;
    let s = e.find((g) => g.route.id === u.route.id),
      d = s != null && !Zf(s, u) && (o && o[u.route.id]) !== void 0;
    if (Pn(a) && (l || d)) {
      let g = r[i];
      W(g, "Expected an AbortSignal for revalidating fetcher deferred result"),
        await Gf(a, g, l).then((m) => {
          m && (n[i] = m || n[i]);
        });
    }
  }
...
function Am(e, t) {
  try {
    let n = e.sessionStorage.getItem(Kf);
    if (n) {
      let r = JSON.parse(n);
...
function $m(e, t) {
  if (t.size > 0) {
    ...
    try {
      e.sessionStorage.setItem(Kf, JSON.stringify(n));
    } catch (r) {
      Dn(
        !1,
...
const kl = E.createContext(null),
  Fu = E.createContext(null),
  In = E.createContext(null),
  Xo = E.createContext(null),
  St = E.createContext({ outlet: null, matches: [], isDataRoute: !1 }),
  Xf = E.createContext(null);
function Bm(e, t) {
  let { relative: n } = t === void 0 ? {} : t;
  yr() || W(!1);
  let { basename: r, navigator: l } = E.useContext(In),
    { hash: o, pathname: i, search: a } = Jo(e, { relative: n }),
    u = i;
  return (
    r !== "/" && (u = i === "/" ? r : zt([r, i])),
...
function yr() {
  return E.useContext(Xo) != null;
}
function hn() {
  return yr() || W(!1), E.useContext(Xo).location;
}
function Jf(e) {
  E.useContext(In).static || E.useLayoutEffect(e);
}
function wr() {
  let { isDataRoute: e } = E.useContext(St);
  return e ? t0() : Hm();
}
function Hm() {
  yr() || W(!1);
  let e = E.useContext(kl),
    { basename: t, navigator: n } = E.useContext(In),
    { matches: r } = E.useContext(St),
    { pathname: l } = hn(),
    o = JSON.stringify(El(r).map((u) => u.pathnameBase)),
    i = E.useRef(!1);
  return (
    Jf(() => {
      i.current = !0;
    ...
    E.useCallback(
      function (u, s) {
        ...
        let d = Go(u, JSON.parse(o), l, s.relative === "path");
        e == null &&
          t !== "/" &&
...
function Vm() {
  return E.useContext(qf);
}
function Wm(e) {
  let t = E.useContext(St).outlet;
  return t && E.createElement(qf.Provider, { value: e }, t);
}
function bf() {
  let { matches: e } = E.useContext(St),
    t = e[e.length - 1];
  return t ? t.params : {};
}
function Jo(e, t) {
  let { relative: n } = t === void 0 ? {} : t,
    { matches: r } = E.useContext(St),
    { pathname: l } = hn(),
    o = JSON.stringify(El(r).map((i) => i.pathnameBase));
  return E.useMemo(() => Go(e, JSON.parse(o), l, n === "path"), [e, o, l, n]);
}
function Qm(e, t, n) {
  yr() || W(!1);
  let { navigator: r } = E.useContext(In),
    { matches: l } = E.useContext(St),
    o = l[l.length - 1],
    i = o ? o.params : {};
  o && o.pathname;
  ...
  if (t) {
    var d;
    let x = typeof t == "string" ? At(t) : t;
    a === "/" || ((d = x.pathname) != null && d.startsWith(a)) || W(!1),
      (s = x);
  } else s = u;
  let g = s.pathname || "/",
    m = a === "/" ? g : g.slice(a.length) || "/",
    S = bn(e, { pathname: m }),
    w = Xm(
      S &&
        S.map((x) =>
...
const Zm = E.createElement(Km, null);
...
function Gm(e) {
  ...
  return (
    ...
    E.createElement(St.Provider, { value: t }, r)
  );
}
function Xm(e, t, n) {
  var r;
...
function e0() {
  ...
  let t = E.useContext(Xf),
    n = qm(Mo.UseRouteError),
    r = tp(Mo.UseRouteError);
  return t || ((e = n.errors) == null ? void 0 : e[r]);
}
function t0() {
  let { router: e } = Jm(ep.UseNavigateStable),
    t = tp(Mo.UseNavigateStable),
    n = E.useRef(!1);
  return (
    Jf(() => {
      n.current = !0;
...
function np(e) {
  ...
  yr() || W(!1);
  let { matches: o } = E.useContext(St),
    { pathname: i } = hn(),
    a = wr(),
    u = Go(
      t,
      El(o).map((d) => d.pathnameBase),
      i,
      l === "path"
    ),
    s = JSON.stringify(u);
...
function n0(e) {
  ...
  yr() && W(!1);
  let a = t.replace(/^\/*/, "/"),
    u = E.useMemo(() => ({ basename: a, navigator: o, static: i }), [a, o, i]);
  ...
  let {
    ...
    w = E.useMemo(() => {
      ...
      return x == null
        ? null
        : {
            location: { pathname: x, search: d, hash: g, state: m, key: S },
            navigationType: l,
          };
    }, [a, s, d, g, m, S, l]);
  return w == null
    ...
    : E.createElement(
        In.Provider,
        { value: u },
        E.createElement(Xo.Provider, { children: n, value: w })
      );
}
new Promise(() => {});
function r0(e) {
...
function u0(e, t) {
  return Lm({
    ...
    future: hr({}, t == null ? void 0 : t.future, { v7_prependBasename: !0 }),
    history: J1({ window: t == null ? void 0 : t.window }),
    hydrationData: (t == null ? void 0 : t.hydrationData) || s0(),
    routes: e,
...
function s0() {
  ...
  return t && t.errors && (t = hr({}, t, { errors: c0(t.errors) })), t;
}
function c0(e) {
  if (!e) return null;
...
const lp = E.createContext({ isTransitioning: !1 }),
  d0 = E.createContext(new Map()),
  f0 = "startTransition",
  yc = $p[f0];
function p0(e) {
  yc ? yc(e) : e();
...
function m0(e) {
  let { fallbackElement: t, router: n, future: r } = e,
    ...
    v = E.useCallback(
      (P, N) => {
        let { deletedFetchers: B, unstable_viewTransitionOpts: F } = N;
        B.forEach((le) => L.current.delete(le)),
          P.fetchers.forEach((le, Ne) => {
            le.data !== void 0 && L.current.set(Ne, le.data);
          }),
          !F ||
          n.window == null ||
  ...
  E.useLayoutEffect(() => n.subscribe(v), [n, v]),
    ...
    E.useEffect(() => {
      if (d && i && n.window) {
        ...
        B.finished.finally(() => {
          g(void 0), S(void 0), a(void 0), s({ isTransitioning: !1 });
        }),
          S(B);
      }
    }, [f, i, d, n.window]),
        ...
        E.createElement(
          ...
          E.createElement(
            ...
            E.createElement(
              ...
              l.initialized
                ? E.createElement(v0, { routes: n.routes, state: l })
                : t
            )
          )
        )
...
const g0 =
  ...
  an = E.forwardRef(function (t, n) {
    let {
      ...
      m = rp(t, i0),
      { basename: S } = E.useContext(In),
      w,
      x = !1;
    if (typeof s == "string" && y0.test(s) && ((w = s), g0))
      try {
        let v = new URL(window.location.href),
          c = s.startsWith("//") ? new URL(v.protocol + s) : new URL(s),
          k = cn(c.pathname, S);
        c.origin === v.origin && k != null
          ? (s = k + c.search + c.hash)
          : (x = !0);
      } catch {}
    let L = Bm(s, { relative: l }),
      p = x0(s, {
        replace: i,
        state: a,
        target: u,
    ...
    return E.createElement(
      "a",
      hr({}, m, { href: w || L, onClick: x || o ? r : f, ref: n, target: u })
    );
  }),
  Di = E.forwardRef(function (t, n) {
    let {
      ...
      g = rp(t, a0),
      m = Jo(u, { relative: g.relative }),
      S = hn(),
      w = E.useContext(Fu),
      { navigator: x } = E.useContext(In),
      L = w != null && S0(m) && s === !0,
    ...
    l ||
      ...
      (p = p.toLowerCase()));
    let c = f === p || (!i && f.startsWith(p) && f.charAt(p.length) === "/"),
      k =
        v != null &&
        (v === p || (!i && v.startsWith(p) && v.charAt(p.length) === "/")),
      j = { isActive: c, isPending: k, isTransitioning: L },
      P = c ? r : void 0,
      N;
    typeof o == "function"
      ? (N = o(j))
...
function S0(e, t) {
  t === void 0 && (t = {});
  let n = E.useContext(lp);
  n == null && W(!1);
  let { basename: r } = w0(Aa.useViewTransitionState),
    l = Jo(e, { relative: t.relative });
  ...
  return Oa(l.pathname, i) != null || Oa(l.pathname, o) != null;
}
const C0 = (e) =>
    E.createElement(
      "svg",
      ...
      E.createElement("circle", { cx: 21, cy: 3, r: 3, fill: "#333" }),
      E.createElement("circle", { cx: 7, cy: 3, r: 3, fill: "#333" })
    ),
  tt = "https://dogsapi.origamid.dev/json";
function E0(e) {
  return {
    url: tt + "/jwt-auth/v1/token",
    options: {
      method: "POST",
...
function k0(e) {
  return {
    url: tt + "/jwt-auth/v1/token/validate",
    options: { method: "POST", headers: { Authorization: "Bearer " + e } },
  };
}
function _0(e) {
  return {
    url: tt + "/api/user",
    options: { method: "GET", headers: { Authorization: "Bearer " + e } },
  };
}
function P0(e) {
  return {
...
function N0({ page: e, total: t, user: n }) {
  return {
    url: `${tt}/api/photo/?_page=${e}&_total=${t}&_user=${n}`,
...
function M0(e, t) {
  return {
    url: `${tt}/api/photo/${e}`,
    options: { method: "DELETE", headers: { Authorization: "Bearer " + t } },
  };
}
function z0() {
  return {
...
const Ct = $.createContext(),
  D0 = ({ children: e }) => {
    const [t, n] = $.useState(""),
      ...
      s = wr();
    async function d(S) {
      const { url: w, options: x } = _0(S),
        p = await (await fetch(w, x)).json();
      n(p), l(!0);
    }
    async function g(S, w) {
      try {
        u(null), i(!0);
        const { url: x, options: L } = E0({ username: S, password: w }),
          p = await fetch(x, L);
        if (!p.ok) throw new Error(`Erro: ${p.statusText}`);
        const { token: f } = await p.json();
        window.localStorage.setItem("token", f), await d(f), s("/account");
      } catch (x) {
        u(x.message), l(!1);
      } finally {
        i(!1);
    ...
    const m = $.useCallback(async function () {
      n(""), u(null), i(!1), l(!1), window.localStorage.removeItem("token");
    }, []);
    return (
      $.useEffect(() => {
        async function S() {
          const w = window.localStorage.getItem("token");
          if (w)
            try {
              u(null), i(!0);
              const { url: x, options: L } = k0(w);
              if (!(await fetch(x, L)).ok) throw new Error("Token inválido");
              await d(w);
            } catch {
              m();
            } finally {
  ...
  U0 = "_logo_1ydwf_33",
  I0 = "_login_1ydwf_41",
  Ur = { header: O0, nav: F0, logo: U0, login: I0 },
  A0 = () => {
    const { data: e } = $.useContext(Ct);
    return h.jsx("header", {
      className: Ur.header,
      children: h.jsxs("nav", {
        className: `${Ur.nav} container`,
        children: [
          h.jsx(an, {
            to: "/",
            className: Ur.logo,
  ...
  H0 = (e) =>
    E.createElement(
      ...
      E.createElement("circle", { cx: 21, cy: 3, r: 3, fill: "#764701" }),
      E.createElement("circle", { cx: 7, cy: 3, r: 3, fill: "#764701" })
    ),
  V0 = () =>
    h.jsxs("footer", {
      className: B0.footer,
      children: [
        h.jsx(H0, {}),
        h.jsx("p", { children: "Dogs. Alguns direitos reservados" }),
      ],
    });
const W0 = () =>
    h.jsx(h.Fragment, {
    ...
    const [e, t] = $.useState(""),
      ...
      i = $.useCallback(async (a, u) => {
        ...
        try {
          ...
          return t(d), r(!1), { response: s, json: d };
        }
      }, []);
    return { data: e, loading: n, error: l, request: i };
  },
  dt = ({ error: e }) =>
    e
      ? h.jsx("p", { style: { color: "#f31", margin: "1rem 0" }, children: e })
      : null,
  Z0 = "_wrapper_1lvks_1",
  Y0 = "_loading_1lvks_21",
  xc = { wrapper: Z0, loading: Y0 },
  qo = () => {
    ...
    $.useEffect(() => {
      ...
      const l = setInterval(r, 300);
      return () => {
        clearInterval(l);
      };
    }, []);
    function n(r) {
      return { display: e === r ? "block" : "none" };
    }
    return h.jsx("div", {
      className: xc.wrapper,
      children: h.jsx("div", {
        className: xc.loading,
        children: h.jsxs("svg", {
          width: "46",
          height: "31",
          viewBox: "0 0 46 31",
  ...
  X0 = "_scaleUp_19gzo_1",
  J0 = "_single_19gzo_29",
  q0 = "_details_19gzo_53",
  b0 = "_img_19gzo_69",
  ev = "_comments_19gzo_89",
  tv = "_author_19gzo_97",
  nv = "_visualizacoes_19gzo_123",
  rv = "_attributes_19gzo_141",
  xn = {
    photo: G0,
    scaleUp: X0,
    single: J0,
  ...
  lv = "_form_u4598_1",
  ov = "_single_u4598_15",
  iv = "_textarea_u4598_23",
  av = "_button_u4598_65",
  uv = "_latir_u4598_1",
  Kl = { form: lv, single: ov, textarea: iv, button: av, latir: uv },
  sv = (e) =>
    E.createElement(
      "svg",
      {
  ...
  cv = ({ id: e, setComments: t, single: n }) => {
    const { error: r, request: l } = Et(),
      [o, i] = $.useState("");
    async function a(u) {
      const s = window.localStorage.getItem("token");
      u.preventDefault();
      const { url: d, options: g } = T0(e, { comment: o }, s),
        { response: m, json: S } = await l(d, g);
      m.ok && (i(""), t((w) => [...w, S]));
    }
    return h.jsxs("form", {
      className: `${Kl.form} ${n ? Kl.single : ""}`,
      onSubmit: a,
      children: [
        h.jsx("textarea", {
          ...
          value: o,
          onChange: ({ target: u }) => i(u.value),
        }),
        h.jsx("button", { className: Kl.button, children: h.jsx(sv, {}) }),
        h.jsx(dt, { error: r }),
      ],
    });
  },
  dv = "_comments_6xhy7_1",
  fv = "_single_6xhy7_13",
  Sc = { comments: dv, single: fv },
  pv = (e) => {
    const [t, n] = $.useState(() => e.comments),
      { login: r } = E.useContext(Ct),
      l = E.useRef(null);
    return (
      $.useEffect(() => {
      ...
      h.jsxs(h.Fragment, {
        children: [
          h.jsx("ul", {
            ref: l,
            className: `${Sc.comments} ${e.single ? Sc.single : ""}`,
            children: t.map((o) =>
              h.jsxs(
                "li",
                {
                  children: [
                    h.jsxs("b", { children: [o.comment_author, ": "] }),
                    h.jsx("span", { children: o.comment_content }),
                  ],
                },
                o.comment_ID
              )
          ...
          r && h.jsx(cv, { single: e.single, id: e.id, setComments: n }),
        ],
      })
    );
  },
  Cc = { delete: "_delete_1s0y8_1" },
  hv = ({ id: e }) => {
    const { loading: t, request: n } = Et();
    async function r() {
      const l = window.confirm("Tem certeza que deseja deletar essa foto?"),
        o = window.localStorage.getItem("token");
      if (l) {
        const { url: i, options: a } = M0(e, o),
          { response: u } = await n(i, a);
        u.ok && window.location.reload();
      }
    }
  ...
  ip = ({ data: e, single: t }) => {
    const { comments: n, photo: r } = e,
      l = E.useContext(Ct);
    return (
      console.log(l.data),
      h.jsxs("div", {
        className: `${xn.photo} ${t ? xn.single : ""}`,
        children: [
          h.jsx("div", {
            className: xn.img,
            children: h.jsx("img", { src: r.src, alt: r.title }),
          }),
          h.jsx("div", {
            className: xn.details,
            children: h.jsxs("div", {
              children: [
                h.jsxs("p", {
                  className: xn.author,
                  children: [
                    l.data.username === r.author
                      ? h.jsx(hv, { id: r.id })
                      : h.jsx(an, {
                          to: `/profile/${r.author}`,
                          children: `@${r.author}`,
                ...
                h.jsxs("ul", {
                  className: xn.attributes,
                  children: [
                    h.jsxs("li", { children: [r.peso, " kg"] }),
                    h.jsxs("li", { children: [r.idade, " anos"] }),
                  ],
                }),
              ],
            }),
          }),
          h.jsx(pv, { single: t, id: r.id, comments: n }),
        ],
      })
    );
  },
  mv = ({ photo: e, setModalPhoto: t }) => {
    const { data: n, error: r, loading: l, request: o } = Et();
    $.useEffect(() => {
      const { url: a, options: u } = op(e.id);
      o(a, u);
    }, [o, e]);
    function i(a) {
      a.target === a.currentTarget && t(null);
    }
    return h.jsxs("div", {
      className: K0.modal,
      onClick: i,
  ...
  gv = { feed: vv },
  yv = "_photo_eocjm_1",
  wv = "_visualizacao_eocjm_49",
  Ec = { photo: yv, visualizacao: wv },
  xv = "_wrapper_11f71_1",
  Sv = "_img_11f71_9",
  Cv = "_skeleton_11f71_25",
  Oi = { wrapper: xv, img: Sv, skeleton: Cv },
  Ev = ({ alt: e, ...t }) => {
    const [n, r] = $.useState(!0);
    function l({ target: o }) {
      r(!1), (o.style.opacity = 1);
    }
    return h.jsxs("div", {
      className: Oi.wrapper,
      children: [
        n && h.jsx("div", { className: Oi.skeleton }),
        h.jsx("img", { onLoad: l, className: Oi.img, alt: e, ...t }),
      ],
    });
  },
  kv = ({ photo: e, setModalPhoto: t }) => {
    function n() {
      t(e);
    }
    return h.jsxs("li", {
      ...
      onClick: n,
      children: [
        h.jsx(Ev, { src: e.src, alt: e.title }),
        h.jsx("span", { className: Ec.visualizacao, children: e.acessos }),
      ],
    });
  },
  _v = ({ setModalPhoto: e, user: t, page: n, setInfinite: r }) => {
    const { data: l, error: o, loading: i, request: a } = Et();
    return (
      $.useEffect(() => {
        async function u() {
          const { url: d, options: g } = N0({ page: n, total: 6, user: t }),
            { response: m, json: S } = await a(d, g);
          m && m.ok && S.length < 6 && r(!1);
        }
        u();
      }, [a, t, n, r]),
      o
        ...
        : l
        ? h.jsx("ul", {
            className: `${gv.feed} animeLeft`,
            children: l.map((u) =>
              h.jsx(kv, { photo: u, setModalPhoto: e }, u.id)
            ),
          })
        : null
    );
...
const Fi = Pc(Nv),
  _l = ({ user: e }) => {
    ...
    return (
        ...
        function s() {
          if (i) {
            const d = window.scrollY,
              g = document.body.offsetHeight - window.innerHeight;
            d > g * 0.75 &&
              !u &&
              (o((m) => [...m, m.length + 1]),
              (u = !0),
      ...
      h.jsxs("div", {
        children: [
          n && h.jsx(mv, { photo: n, setModalPhoto: r }),
          l.map((u) =>
            h.jsx(
              _v,
              { user: t || e, page: u, setModalPhoto: r, setInfinite: a },
              u
            )
          ),
        ],
...
_l.defaultProps = { user: 0 };
_l.propTypes = {
  user: Fi.oneOfType([Fi.string.isRequired, Fi.number.isRequired]),
};
const kt = (e) => (
    $.useEffect(() => {
      (document.title = e.title + " | Dogs"),
        document
  ...
  Mv = "_login_1c0t6_1",
  zv = "_forms_1c0t6_29",
  kc = { login: Mv, forms: zv },
  Dv = () => {
    const { login: e } = $.useContext(Ct);
    return e
      ? h.jsx(np, { to: "/account" })
      : h.jsx("section", {
          className: kc.login,
  ...
  Ov = "_form_k9rb5_1",
  Fv = "_perdeu_k9rb5_9",
  Uv = "_cadastro_k9rb5_39",
  Iv = "_subtitle_k9rb5_59",
  Zl = { form: Ov, perdeu: Fv, cadastro: Uv, subtitle: Iv },
  Av = "_button_14lik_1",
  cp = { button: Av },
  $v = "_wrapper_alcqh_1",
  Bv = "_input_alcqh_9",
  Hv = "_label_alcqh_47",
  Vv = "_error_alcqh_61",
  Ui = { wrapper: $v, input: Bv, label: Hv, error: Vv },
  yt = ({
    label: e,
    type: t,
    name: n,
    ...
    h.jsxs("div", {
      ...
      children: [
        h.jsx("label", { htmlFor: n, className: Ui.label, children: e }),
        h.jsx("input", {
          type: t,
          id: n,
          className: Ui.input,
  ...
  wt = (e) => {
    ...
    function o(a) {
      return e === !1
        ? !0
        : a.length === 0
        ? (l("Preencha o campo com um valor"), !1)
        : Ii[e] && !Ii[e].Regex.test(a)
        ? (l(Ii[e].message), !1)
        : (l(null), !0);
    }
    function i({ target: a }) {
      r && o(a.value), n(a.value), console.log(a.value);
    }
    return {
      value: t,
      setValue: n,
  ...
  xt = ({ children: e, ...t }) =>
    h.jsx("button", { className: cp.button, ...t, children: e }),
  Wv = () => {
    const e = wt(),
      t = wt(),
      { userLogin: n, error: r, loading: l } = $.useContext(Ct);
    async function o(i) {
      i.preventDefault(), e.validate() && t.validate() && n(e.value, t.value);
    }
    return h.jsxs("section", {
      className: "animeLet",
      children: [
        h.jsx(kt, { title: "Login" }),
        h.jsx("h1", { className: "title", children: "Login" }),
        h.jsxs("form", {
          onSubmit: o,
          className: Zl.form,
          children: [
            ...
            l
              ? h.jsx(xt, { disabled: !0, children: "Entrando..." })
              : h.jsx(xt, { children: "Entrar" }),
            h.jsx(dt, { error: r && "Dados incorretos" }),
          ],
        }),
        h.jsx(an, {
          to: "/login/lost",
          className: Zl.perdeu,
          children: "Perdeu a senha?",
        }),
        h.jsxs("div", {
          className: Zl.cadastro,
          children: [
            h.jsx("h2", { className: Zl.subtitle, children: "Cadastre-se" }),
            h.jsx("p", {
              children: "Ainda não possui conta? Cadastre-se no site",
            }),
            h.jsx(an, {
              to: "/login/create",
              className: cp.button,
  ...
  Qv = () => {
    const e = wt(),
      t = wt("email"),
      n = wt("password"),
      { loading: r, error: l, request: o } = Et(),
      { userLogin: i } = $.useContext(Ct);
    async function a(u) {
      u.preventDefault();
      const { url: s, options: d } = P0({
          username: e.value,
          email: t.value,
          password: n.value,
        }),
        { response: g } = await o(s, d);
      g.ok && i(e.value, n.value);
    }
    return h.jsxs("section", {
      className: "animeLeft",
      children: [
        h.jsx(kt, { title: "Criar conta" }),
        h.jsx("h1", { className: "title", children: "Cadastre-se" }),
        h.jsxs("form", {
          onSubmit: a,
          children: [
            h.jsx(yt, {
            ...
            h.jsx(yt, { label: "Email", type: "email", name: "email", ...t }),
            h.jsx(yt, {
              label: "Senha",
              type: "password",
              name: "password",
            ...
            r
              ? h.jsx(xt, { disabled: !0, children: "Cadastrando..." })
              : h.jsx(xt, { children: "Cadastrar" }),
            h.jsx(dt, { error: l }),
          ],
        }),
      ],
  ...
  Kv = () => {
    const e = wt(),
      { data: t, loading: n, error: r, request: l } = Et();
    async function o(i) {
      if ((i.preventDefault(), e.validate())) {
        const { url: a, options: u } = R0({
            login: e.value,
    ...
    return h.jsxs("section", {
      className: "animeLeft",
      children: [
        h.jsx(kt, { title: "Perdeu a senha?" }),
        h.jsx("h1", { className: "title", children: "Perdeu a senha?" }),
        t
          ? h.jsx("p", { style: { color: "#4c1" }, children: t })
          : h.jsxs("form", {
              onSubmit: o,
              children: [
                h.jsx(yt, {
                ...
                n
                  ? h.jsx(xt, { disabled: !0, children: "Enviando..." })
                  : h.jsx(xt, { children: "Enviar" }),
                h.jsx(dt, { error: r }),
              ],
            }),
      ],
  ...
  Zv = () => {
    const [e, t] = $.useState(""),
      [n, r] = $.useState(""),
      { loading: l, error: o, request: i } = Et(),
      a = wt("password"),
      u = wr();
    $.useEffect(() => {
    ...
    async function s(d) {
      if ((d.preventDefault(), a.validate())) {
        const { url: g, options: m } = L0({
            login: e,
            key: n,
            password: a.value,
          }),
          { response: S } = await i(g, m);
        S.ok && u("/login");
      }
    }
    return h.jsxs("section", {
      className: "animeLeft",
      children: [
        h.jsx(kt, { title: "Reset a senha" }),
        h.jsx("h1", { className: "title", children: "Resete sua senha" }),
        h.jsxs("form", {
          onSubmit: s,
          children: [
            h.jsx(yt, {
            ...
            l
              ? h.jsx(xt, { disabled: !0, children: "Resetando..." })
              : h.jsx(xt, { children: "Resetar senha" }),
            h.jsx(dt, { error: o }),
          ],
        }),
      ],
  ...
  Yv = ({ children: e }) => {
    const { login: t } = $.useContext(Ct);
    return t ? e : t === !1 ? h.jsx(np, { to: "/login" }) : h.jsx("p", {});
  },
  Gv = "_header_h6rvj_1",
  Xv = { header: Gv },
  Jv = (e) => {
    ...
    return (
      $.useEffect(() => {
        function r() {
          const { matches: l } = window.matchMedia(e);
          n(l);
        }
        return (
          r(),
  ...
  ng = "_nav_1glu9_1",
  rg = "_mobileButton_1glu9_81",
  lg = "_mobileButtonActive_1glu9_135",
  og = "_navMobile_1glu9_165",
  ig = "_navMobileActive_1glu9_193",
  Ir = {
    nav: ng,
    mobileButton: rg,
    mobileButtonActive: lg,
    navMobile: og,
    navMobileActive: ig,
  },
  ag = () => {
    const { userLogout: e } = $.useContext(Ct),
      [t, n] = $.useState(!1),
      r = Jv("(max-width: 40rem"),
      l = wr(),
      { pathname: o } = hn();
    $.useEffect(() => {
      n(!1);
    ...
    return h.jsxs(h.Fragment, {
      children: [
        r &&
          h.jsx("button", {
            "aria-label": "Menu",
            className: `${Ir.mobileButton} 
                    ${t && Ir.mobileButtonActive}`,
            onClick: () => n(!t),
          }),
        h.jsxs("nav", {
          className: `${r ? Ir.navMobile : Ir.nav} 
            ${t && Ir.navMobileActive}`,
          children: [
            h.jsxs(Di, {
              to: "/account",
              end: !0,
              children: [h.jsx(qv, {}), r && "Minhas fotos"],
            }),
            h.jsxs(Di, {
              to: "/account/statistics",
              children: [h.jsx(bv, {}), r && "Estatísticas"],
            }),
            h.jsxs(Di, {
              to: "/account/post",
              children: [h.jsx(eg, {}), r && "Adicionar foto"],
            }),
            h.jsxs("button", {
              onClick: i,
              children: [h.jsx(tg, {}), r && "Sair"],
            }),
          ],
        }),
      ],
  ...
  ug = () => {
    ...
    return (
      ...
      h.jsxs("header", {
        className: Xv.header,
        children: [
          h.jsx("h1", { className: "title", children: e }),
          h.jsx(ag, {}),
        ],
      })
    );
  ...
  sg = () => {
    ...
    return h.jsx(Yv, {
      children: h.jsxs("section", {
        className: "container",
        children: [
          h.jsx(kt, { title: "Minha conta" }),
          h.jsx(ug, {}),
          h.jsx(Uu, { context: e.id }),
        ],
      }),
    });
  },
  cg = "_photoPost_sc5f7_1",
  dg = "_file_sc5f7_27",
  fg = "_preview_sc5f7_35",
  Ai = { photoPost: cg, file: dg, preview: fg },
  pg = () => {
    const [e, t] = $.useState({}),
      { data: n, loading: r, error: l, request: o } = Et(),
      i = wt(),
      a = wt("number"),
      u = wt("number"),
      s = wr();
    ...
    function d(m) {
      ...
      S.append("img", e.raw),
        S.append("nome", i.value),
        S.append("peso", a.value),
        S.append("idade", u.value);
      const w = window.localStorage.getItem("token"),
        { url: x, options: L } = j0(S, w);
      o(x, L);
    }
    function g({ target: m }) {
      t({ preview: URL.createObjectURL(m.files[0]), raw: m.files[0] });
    }
    return h.jsxs("section", {
      className: `${Ai.photoPost} animeLeft`,
      children: [
        h.jsx(kt, { title: "Poste sua foto" }),
        h.jsxs("form", {
          onSubmit: d,
          children: [
            h.jsx(yt, { label: "Nome:", type: "text", name: "name", ...i }),
            h.jsx(yt, { label: "Peso:", type: "number", name: "weight", ...a }),
            h.jsx(yt, { label: "Idade:", type: "number", name: "age", ...u }),
            h.jsx("input", {
              className: Ai.file,
              type: "file",
              name: "img",
      ...
      n.map((o) => {
        ...
        if (!!r)
          for (let d = l.length - 1; d >= 0; d--) {
            const g = l[d];
            if (g.href === o && (!i || g.rel === "stylesheet")) return;
          }
        else if (document.querySelector(`link[href="${o}"]${a}`)) return;
        const s = document.createElement("link");
        if (
          ((s.rel = i ? "stylesheet" : hg),
          ...
          return new Promise((d, g) => {
            s.addEventListener("load", d),
              s.addEventListener("error", () =>
                g(new Error(`Unable to preload CSS for ${o}`))
              );
          });
      })
    )
  ...
  gg = $.lazy(() =>
    vg(
      () => import("./UserStatsGraphs-f1a2a37e.js"),
      [
        "assets/UserStatsGraphs-f1a2a37e.js",
        "assets/UserStatsGraphs-f4868e86.css",
      ]
    )
  ),
  yg = () => {
    const { data: e, error: t, loading: n, request: r } = Et();
    return (
      $.useEffect(() => {
        async function l() {
          const { url: o, options: i } = z0();
          await r(o, i);
        }
        l();
      }, [r]),
  ...
  wg = () => {
    ...
    if (
      ($.useEffect(() => {
        const { url: o, options: i } = op(e);
        l(o, i);
      }, [l, e]),
      r)
    )
      return h.jsx(dt, {});
    if (n) return h.jsx(qo, {});
    if (t)
      return h.jsxs("section", {
        className: "container mainContainer",
        children: [
          h.jsx(kt, { title: t.photo.title }),
          h.jsx(ip, { single: !0, data: t }),
        ],
      });
  },
  xg = () => {
  ...
  $i = () =>
    h.jsxs("div", {
      className: "container mainContainer",
      children: [
        h.jsx("h1", { className: "title", children: "Erro: 404" }),
        h.jsx("p", { children: "Página não encontrada" }),
      ],
    }),
  Sg = u0([
    {
      ...
      children: [
        { index: !0, element: h.jsx(Tv, {}) },
        {
          ...
          element: h.jsx(Dv, {}),
          children: [
            { index: !0, element: h.jsx(Wv, {}) },
            { path: "create", element: h.jsx(Qv, {}) },
            { path: "lost", element: h.jsx(Kv, {}) },
            { path: "reset", element: h.jsx(Zv, {}) },
            { path: "*", element: h.jsx($i, {}) },
          ],
        },
        {
          path: "account",
          element: h.jsx(sg, {}),
          children: [
            { index: !0, element: h.jsx(_l, {}) },
            { path: "post", element: h.jsx(pg, {}) },
            { path: "statistics", element: h.jsx(yg, {}) },
            { path: "*", element: h.jsx($i, {}) },
          ],
        },
        { path: "photo/:id", element: h.jsx(wg, {}) },
        { path: "profile/:user", element: h.jsx(xg, {}) },
        { path: "*", element: h.jsx($i, {}) },
      ],
    },
  ]);
function Cg() {
  return h.jsx(h.Fragment, { children: h.jsx(m0, { router: Sg }) });
}
Bi.createRoot(document.getElementById("root")).render(h.jsx(Cg, {}));
export { Fi as P, $ as R, Eg as c, Pc as g, h as j, E as r };
